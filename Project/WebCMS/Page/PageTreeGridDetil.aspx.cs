...
public partial class PageTreeGridDetil : System.Web.UI.Page
{
  ...
  public void RefreshPreview()
  {
    ...
    {
      url = url.Replace("PageTreeGridDetil.aspx", "PageTabular.aspx");
    }
  ...
  public void RefreshPreview2()
  {
    ...
    if (typeof(IDataControlUI).IsInstanceOfType(dc))
    {
      url = url.Replace("PageTreeGridDetil.aspx", "PageTreePanelDetil.aspx");
    }
    if (!url.Contains("passdc"))
    {
      url += "&passdc=1";
