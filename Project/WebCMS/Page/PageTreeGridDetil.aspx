<%@ Page Language="C#" AutoEventWireup="True" ValidateRequest="false" Inherits="PageTreeGridDetil"
  CodeFile="PageTreeGridDetil.aspx.cs" %>
  ...
  <ext:Viewport ID="Viewport1" runat="server" Layout="Fit">
    <Items>
      <ext:Panel ID="PanelCenter" runat="server" Layout="BorderLayout">
        <Items>
          <ext:TreeGrid ID="TreeGrid1" runat="server" Width="300" Height="240" NoLeafIcon="false"
