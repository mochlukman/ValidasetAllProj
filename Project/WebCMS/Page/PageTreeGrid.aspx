<%@ Page Language="C#" AutoEventWireup="True" ValidateRequest="false" Inherits="PageTreeGrid"
  CodeFile="PageTreeGrid.aspx.cs" %>
  ...
  <ext:Viewport ID="Viewport1" runat="server" Layout="Fit">
    <Items>
      <ext:Panel ID="PanelCenter" runat="server" Layout="BorderLayout">
        <Items>
          <ext:TreeGrid ID="TreeGrid1" runat="server" Width="300" Height="300" NoLeafIcon="false"
            RootVisible="false" EnableDD="true" Region="Center">
            <Loader>
              <ext:PageTreeLoader OnNodeLoad="LoadPages" Timeout="360000" />
            </Loader>
            <BottomBar>
              <ext:Toolbar ID="BottomBar1" runat="server" Hidden="false" />
            </BottomBar>
          </ext:TreeGrid>
