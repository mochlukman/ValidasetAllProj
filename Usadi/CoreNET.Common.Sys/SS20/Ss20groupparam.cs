...
{
  #region Ss20groupparam
  [Serializable]
  public class Ss20groupparamControl : BaseDataControlSys, IDataControlUIEntry, IExtLoadCsv, IHasJSScript
  {
    #region Properties 
    ...
    public new IProperties GetProperties()
    {
      ...
      cViewListProperties.PrimaryKeys = new String[] { "Par" };
    ...
    public override DataControlFieldCollection GetColumns()
    {
      ...
      columns.Add(Fields.Create(ConstantDict.GetColumnTitle("Desciption"), typeof(string), 10, HorizontalAlign.Left));
    ...
    public new IList View(string label)
    {
      ...
      List<Ss20groupparamControl> ListData = new List<Ss20groupparamControl>();
      foreach(Ss20groupparamControl dc in list)
      {
    ...
    public override HashTableofParameterRow GetEntries()
    {
      ...
      hpars.Add(new ParameterRowTextBox(this, ConstantDict.GetColumnTitle("Desciption"), false, 90).SetEnable(enable));
