...
{
  #region CoreNET.Common.BO.Ss20groupmenuControl, CoreNET.Common.BO
  [Serializable]
  public class Ss20groupmenuControl : Ss01appmenuControl, IDataControlTreeGrid3, IHasJSScript, IExtLoadCsv
  {
    #region Methods 
    public Ss20groupmenuControl()
    {
