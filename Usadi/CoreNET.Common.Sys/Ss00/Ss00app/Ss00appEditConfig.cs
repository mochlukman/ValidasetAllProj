...
{
  #region CoreNET.Common.BO.Ss00appEditConfigControl, CoreNET.Common.BO
  /**
   * Struktur Menu dan Monitoring di Modul Testing
   * as DCMenu where Idapp='68065186-FF1B-4EB3-8A6B-6D1FDCFD3BAD'
   * */
  [Serializable]
  public class Ss00appEditConfigControl : Ss00appLinkControl, IDataControlTreeGrid3, IHasJSScript
  {
    public Ss00appEditConfigControl()
    {
    ...
    public new IList View(string label)
    {
      ...
      foreach (SsappControl dc in list)
      {
        ...
        string idmenu = "C367A44A-6D7D-42BA-9A86-46324E0161A4";
