...
{
  #region CoreNET.Common.BO.Ss00appMsgControl, CoreNET.Common.BO
  /**
   * Struktur Menu dan Monitoring di Modul Testing
   * as DCMenu where Idapp='68065186-FF1B-4EB3-8A6B-6D1FDCFD3BAD'
   * */
  [Serializable]
  public class Ss00appMsgControl : Ss00appMonControl, IDataControlTreeGrid3, IHasJSScript
  {
    public Ss00appMsgControl()
    {
