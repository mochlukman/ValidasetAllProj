...
{
  #region CoreNET.Common.BO.Ss00appEditMenuControl, CoreNET.Common.BO
  /**
   * Struktur Menu dan Monitoring di Modul Testing
   * as DCMenu where Idapp='68065186-FF1B-4EB3-8A6B-6D1FDCFD3BAD'
   * */
  [Serializable]
  public class Ss00appEditMenuControl : Ss00appLinkControl, IDataControlTreeGrid3, IHasJSScript
  {
    public Ss00appEditMenuControl()
    {
    ...
    public new IList View(string label)
    {
      ...
      foreach (SsappControl dc in list)
      {
        ...
        string idmenu = "94532ecd-377c-43f6-a494-599a73ad5fdd";
