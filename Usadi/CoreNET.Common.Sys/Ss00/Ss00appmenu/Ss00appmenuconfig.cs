...
{
  #region Ss00appmenuconfig
  [Serializable]
  public class Ss00appmenuconfigControl : BaseDataControlSys, IDataControlUIEntry, IExtLoadCsv, IHasJSScript
  {
    #region Properties 
    ...
    #region Methods 
    public Ss00appmenuconfigControl()
    {
    ...
    public new IProperties GetProperties()
    {
      ...
      cViewListProperties.PrimaryKeys = new String[] { "Idmenu" };
    ...
    public override DataControlFieldCollection GetColumns()
    {
      ...
      columns.Add(Fields.Create(ConstantDict.GetColumnTitle("Par"), typeof(string), 10, HorizontalAlign.Left));
    ...
    public new IList View(string label)
    {
      ...
      List<Ss00appmenuconfigControl> ListData = new List<Ss00appmenuconfigControl>();
      foreach (Ss00appmenuconfigControl dc in list)
      {
