...
namespace CoreNET.Common.BO
{
  #region Ss00appissue
  [Serializable]
  public class Ss00appissueControl : BaseDataControlSys, IDataControlUIEntry, IExtLoadCsv, IHasJSScript
  {
    #region Properties 
    ...
    public string Urissue { get; set; }
    #endregion Properties 

    #region Methods 
    public Ss00appissueControl()
    {
    ...
    public new IProperties GetProperties()
    {
      ...
      cViewListProperties.PrimaryKeys = new String[] { "Idissue" };
    ...
    public override DataControlFieldCollection GetColumns()
    {
      ...
      columns.Add(Fields.Create(ConstantDict.GetColumnTitle("Idmenu"), typeof(string), 10, HorizontalAlign.Left));
      columns.Add(Fields.Create(ConstantDict.GetColumnTitle("Urissue"), typeof(string), 10, HorizontalAlign.Left));
      columns.Add(Fields.Create(ConstantDict.GetColumnTitle("Pic"), typeof(string), 10, HorizontalAlign.Left));
    ...
    public new IList View(string label)
    {
      ...
      List<Ss00appissueControl> ListData = new List<Ss00appissueControl>();
      foreach (Ss00appissueControl dc in list)
      {
    ...
    public override HashTableofParameterRow GetEntries()
    {
      bool enable = false;
      HashTableofParameterRow hpars = new HashTableofParameterRow();
      hpars.Add(new ParameterRowTextBox(this, ConstantDict.GetColumnTitle("Idissue"), false, 70).SetEnable(enable));
      hpars.Add(new ParameterRowTextBox(this, ConstantDict.GetColumnTitle("Idmenu"), false, 70).SetEnable(enable));
      hpars.Add(new ParameterRowTextBox(this, ConstantDict.GetColumnTitle("Urissue"), false, 90).SetEnable(enable));
      hpars.Add(new ParameterRowTextBox(this, ConstantDict.GetColumnTitle("Pic"), false, 90).SetEnable(enable));
