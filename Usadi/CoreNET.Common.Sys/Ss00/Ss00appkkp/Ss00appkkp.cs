...
namespace CoreNET.Common.BO
{
  #region Ss00appkkp
  [Serializable]
  public class Ss00appkkpControl : BaseDataControlSys, IDataControlUIEntry, IExtLoadCsv, IHasJSScript, IPageMaster
  {
    #region Properties 
    ...
    #region Methods 
    public Ss00appkkpControl()
    {
      XMLName = ConstantTablesSys.XMLSS00APPKKP;
    }
    public new IProperties GetProperties()
    {
      ViewListProperties cViewListProperties = (ViewListProperties)base.GetProperties();
      cViewListProperties.TitleList = ConstantDict.Translate(XMLName);
      cViewListProperties.PrimaryKeys = new String[] { "Idapp", "Iddok" };
    ...
    public static Ss00appkkpControl GetLastNodok(string idapp, string kddok)
    {
      Ss00appkkpControl dc = new Ss00appkkpControl
      {
        Idapp = idapp,
        Nodok = kddok
      };
      ...
      {
        return (Ss00appkkpControl)list[0];
      }
    ...
    public new IList View(string label)
    {
      ...
      List<Ss00appkkpControl> ListData = new List<Ss00appkkpControl>();
      foreach (Ss00appkkpControl dc in list)
      {
    ...
    public new int Update()
    {
      ...
      //Pm01appmenuControl dcMenu = (Pm01appmenuControl)GlobalExt.GetSessionMenu();
      ...
      //try
      //{
      //  Pm01appmenuControl dc = new Pm01appmenuControl();
      //  dc.Idapp = HttpContext.Current.Request["app"];
      //  dc.Idmenu = HttpContext.Current.Request["id"];
      //  dc = Pm01appmenuLookupControl.FindAndSetValuesInto(dc);
      //  dc.Nodok = Nodok;
      //  dc.Nfiles = Nfiles;
    ...
    public Dictionary<string, object> GetPageMasterProperties()
    {
      ...
      {
        [PageMasterProperties.URLMASTER] = string.Format("PageTabular.aspx?app={0}&i={1}&id={2}&kode={3}&idx={4}&child=1&val={5}", app, 1, id, kode, idx, GlobalAsp.GetRequestVal()),
        [PageMasterProperties.URLDETILS] = new string[] {
        string.Format("PageTreeGrid.aspx?app={0}&i={1}&id={2}&kode={3}&idx={4}", app, 11, id, kode,idx)
      }
      };
      return Props;
    }
  }
  #endregion Ss00appkkp
}
