...
{
  #region Ss00appregconfig
  [Serializable]
  public class Ss00appregconfigControl : BaseDataControlSys, IDataControlUIEntry, IExtLoadCsv, IHasJSScript
  {
    #region Properties 
    ...
    #region Methods 
    public Ss00appregconfigControl()
    {
    ...
    public new IProperties GetProperties()
    {
      ...
      cViewListProperties.PrimaryKeys = new String[] { "Idreg","Par" };
    ...
    public new IList View(string label)
    {
      ...
      List<Ss00appregconfigControl> ListData = new List<Ss00appregconfigControl>();
      foreach(Ss00appregconfigControl dc in list)
      {
    ...
    public override HashTableofParameterRow GetEntries()
    {
      bool enable = false;
      HashTableofParameterRow hpars = new HashTableofParameterRow();
      hpars.Add(new ParameterRowTextBox(this, ConstantDict.GetColumnTitle("Idreg"), false, 70).SetEnable(enable));
