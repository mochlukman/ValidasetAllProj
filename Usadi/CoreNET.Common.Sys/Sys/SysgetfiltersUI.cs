...
{
  #region CoreNET.Common.BO.SysgetfiltersUIControl, CoreNET.Common.Sys
  [Serializable]
  public class SysgetfiltersUIControl : SysgetfiltersControl, IDataControlUIEntry, IExtLoadCsv, IHasJSScript
  {
    #region Methods 
    public SysgetfiltersUIControl()
    {
    ...
    {
      base.Insert();
      SysgetfiltersLookupControl.SetListDataNull();
    }
    public new int Update()
    {
      SysgetfiltersControl dc = (SysgetfiltersControl)GlobalExt.GetEditingObject();
      ...
      if (ctrl != null)
      {
        ...
        if (hpars.Count > 0)
        {
          try
          {
            ...
            {
              SysgetfiltersUIControl dc = new SysgetfiltersUIControl
              {
                Typename = Typename,
                Rowname = pr.Name,
                Rowtype = pr.Type
        ...
        {
          ctrl = (IDataControlUIEntry)UtilityBO.Create(typename);
          BaseDataAdapter.GetListDC(ctrl, string.Format("InsertDefaultfilters '{0}','{1}'",
  ...
  #endregion CoreNET.Common.BO.SysgetfiltersUIControl, CoreNET.Common.Sys
}
