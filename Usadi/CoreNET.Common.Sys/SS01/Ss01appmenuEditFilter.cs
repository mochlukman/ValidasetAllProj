...
{
  #region Ss01appmenuEditFilterControl
  /**
  * Used In : IDMENU = 637317A5-5DA3-4991-9CC2-468037264102 (Modul Developer 01.12.02.03.)
  * */
  [Serializable]
  public class Ss01appmenuEditFilterControl : Ss01appmenuEditConfigControl, IDataControlTreeGrid3, IHasJSScript, ICsv, IExtLoadCsv
  {
    public Ss01appmenuEditFilterControl()
    {
    ...
    public new IList View(string label)
    {
      ...
      foreach (Ss01appmenuControl dc in list)
      {
        ...
        string idmenu = "3D32D35C-13EC-4E7E-AE10-703F5827447C";
  ...
  #endregion Ss01appmenuEditFilterControl
}
