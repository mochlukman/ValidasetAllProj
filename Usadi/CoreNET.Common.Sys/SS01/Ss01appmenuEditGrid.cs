...
{
  #region Ss01appmenuEditGridControl
  /**
  * Used In : IDMENU = 637317A5-5DA3-4991-9CC2-468037264102 (Modul Developer 01.12.02.03.)
  * */
  [Serializable]
  public class Ss01appmenuEditGridControl : Ss01appmenuEditConfigControl, IDataControlTreeGrid3, IHasJSScript, ICsv, IExtLoadCsv
  {
    public Ss01appmenuEditGridControl()
    {
    ...
    public new IList View(string label)
    {
      ...
      foreach (Ss01appmenuControl dc in list)
      {
        ...
        string idmenu = "296B3685-8851-473A-BD47-A430D92AF753";
  ...
  #endregion Ss01appmenuEditGridControl
}
