...
{
  #region Ss01appmenuEditVersiControl
  /**
  * Used In : IDMENU = 637317A5-5DA3-4991-9CC2-468037264102 (Modul Developer 01.12.02.03.)
  * */
  [Serializable]
  public class Ss01appmenuEditVersiControl : Ss01appmenuEditConfigControl, IDataControlTreeGrid3, IHasJSScript, ICsv, IExtLoadCsv
  {
    public Ss01appmenuEditVersiControl()
    {
    ...
    public new IList View(string label)
    {
      ...
      {
        //Error View State
        //string cname = "CoreNET.Common.BO.Ss01appmenukkpControl, CoreNET.Common.Sys";
        //string url = $"Page/PageForm.aspx?app={GlobalAsp.GetSessionApp()}&dc={cname}&val={dc.Idapp}";
        string idmenu = "0A58A1A6-2B21-4BEE-ABD2-27F70F2DFF2D";
  ...
  #endregion Ss01appmenuEditVersiControl
}
