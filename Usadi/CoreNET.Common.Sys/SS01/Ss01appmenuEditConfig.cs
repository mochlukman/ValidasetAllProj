...
{
  #region Ss01appmenuEditConfigControl
  /**
  * Used In : IDMENU = 637317A5-5DA3-4991-9CC2-468037264102 (Modul Developer 01.12.02.03.)
  * */
  [Serializable]
  public class Ss01appmenuEditConfigControl : Ss01appmenuRegControl, IDataControlTreeGrid3, IHasJSScript, ICsv, IExtLoadCsv
  {
    public Ss01appmenuEditConfigControl()
    {
  ...
  #endregion Ss01appmenuEditConfigControl
}
