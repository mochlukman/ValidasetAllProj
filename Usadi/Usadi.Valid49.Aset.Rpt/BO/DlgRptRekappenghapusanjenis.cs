...
{
  #region Usadi.Valid49.BO.DlgRptRekappenghapusanjenisControl, Usadi.Valid49.Aset.Rpt
  [Serializable]
  public class DlgRptRekappenghapusanjenisControl : DaftunitControl, IDataControlUIEntry, IPrintable
  {
    ...
    public DlgRptRekappenghapusanjenisControl()
    {
    ...
    public override HashTableofParameterRow GetEntries()
    {
      ...
      hpars.Add(new ParameterRow(ConstantDict.GetColumnTitleEntry("StrMode=Penghapusan"), ParameterRow.MODE_SELECT,
    ...
    public string GetURLReport(int n)
    {
      ...
      CS[ReportUtils.RPTNAME] = $"REKAPPENGHAPUSAN_PEMINDAHTANGANAN_JENIS{StrMode}.rpt";
      CS[ReportUtils.PDFNAME] = $"REKAPPENGHAPUSAN_{StrMode}_{(string)GlobalAsp.GetSessionUser().GetValue("Userid")}_{ DateTime.Now.ToString("yyyyMMddHHmmss")}.pdf";
      ...
      MapMode["pemindahtanganan"] = "PEMINDAHTANGANAN_JENIS";
      MapMode["pengalihan status"] = "PENGALIHANSTATUS_JENIS";
      MapMode["putusan pengadilan"] = "PUTUSANPENGADILAN_JENIS";
      MapMode["perpu"] = "PERPU_JENIS";
      MapMode["musnah"] = "MUSNAH_JENIS";
      MapMode["sebab lain"] = "SEBABLAIN_JENIS";
      MapMode["semua"] = "SEMUA_JENIS";

      string cname = "Usadi.Valid49.Aset.Rpt.Rpt.REKAPPENGHAPUSAN_PEMINDAHTANGANAN_JENIS.rpt";
      if (!StrMode.Equals("default"))
      {
        //string strmode = StrMode.Replace(" ", "");
        string strmode = MapMode[StrMode.ToLower()];
        cname = $"Usadi.Valid49.Aset.Rpt.Rpt.REKAPPENGHAPUSAN_{strmode}.rpt";
      }
      ...
      {
        CS[ReportUtils.PDFNAME] = $"REKAPPENGHAPUSAN_{StrMode}_"+ (string)GlobalAsp.GetSessionUser().GetValue("Userid") + "_" + DateTime.Now.ToString("yyyyMMddHHmmss") + ".xls";
        pdfurl = ReportUtils.ExportPDF(cname, CS, Params);
      }
      return pdfurl;
  ...
  #endregion DlgRptRekappenghapusanjenis
}
