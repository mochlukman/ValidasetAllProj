...
{
  #region Usadi.Valid49.BO.DlgRptDaftbmdprovriauControl, Usadi.Valid49.Aset.Rpt
  [Serializable]
  public class DlgRptDaftbmdprovriauControl : DaftunitControl, IDataControlUIEntry, IPrintable
  {
    ...
    public DlgRptDaftbmdprovriauControl()
    {
    ...
    public string GetURLReport(int n)
    {
      ...
      CS[ReportUtils.RPTNAME] = "DAFTBMD_PROVRIAU.rpt";
      CS[ReportUtils.PDFNAME] = "DAFTBMD_PROVRIAU_" + (string)GlobalAsp.GetSessionUser().GetValue("Userid") + "_" + DateTime.Now.ToString("yyyyMMddHHmmss") + ".pdf";
      ...
      string pdfurl = ReportUtils.ExportPDF("Usadi.Valid49.Aset.Rpt.Rpt.DAFTBMD_PROVRIAU.rpt", CS, Params);
      return pdfurl;
    }
  ...
  #endregion DlgRptDaftbmdprovriau
}
