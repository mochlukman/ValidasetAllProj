...
{
  #region Usadi.Valid49.BO.DlgRptKertaskerjakibcControl, Usadi.Valid49.Aset.Rpt
  [Serializable]
  public class DlgRptKertaskerjakibcControl : DaftunitControl, IDataControlUIEntry, IPrintable
  {
    ...
    public DlgRptKertaskerjakibcControl()
    {
    ...
    public string GetURLReport(int n)
    {
      ...
      CS[ReportUtils.RPTNAME] = "KERTASKERJA_KIBC.rpt";
      CS[ReportUtils.PDFNAME] = "KERTASKERJA_KIBC_" + (string)GlobalAsp.GetSessionUser().GetValue("Userid") + "_" + DateTime.Now.ToString("yyyyMMddHHmmss") + ".pdf";
      ...
      if(n == 0)
      {
        pdfurl = ReportUtils.ExportPDF("Usadi.Valid49.Aset.Rpt.Rpt.KERTASKERJA_KIBC.rpt", CS, Params);
      }
      else
      {
        CS[ReportUtils.PDFNAME] = "KERTASKERJA_KIBC_" + (string)GlobalAsp.GetSessionUser().GetValue("Userid") + "_" + DateTime.Now.ToString("yyyyMMddHHmmss") + ".xls";
        pdfurl = ReportUtils.ExportExcel("Usadi.Valid49.Aset.Rpt.Rpt.KERTASKERJA_KIBC.rpt", CS, Params);
      } 
      return pdfurl;
    }
  ...
  #endregion DlgRptKertaskerjakibc
}
