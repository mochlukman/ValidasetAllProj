...
{
  #region Usadi.Valid49.BO.DlgRptBukubrgtrControl, Usadi.Valid49.Aset.Rpt
  [Serializable]
  public class DlgRptBukubrgtrControl : DaftunitControl, IDataControlUIEntry, IPrintable
  {
    ...
    public string GetURLReport(int n)
    {
      ...
      CS[ReportUtils.RPTNAME] = "BUKUBRGTR.rpt";
      CS[ReportUtils.PDFNAME] = "BUKUBRGTR_" + (string)GlobalAsp.GetSessionUser().GetValue("Userid") + "_" + DateTime.Now.ToString("yyyyMMddHHmmss") + ".pdf";
      ...
      if(n == 0)
      {
        pdfurl = ReportUtils.ExportPDF("Usadi.Valid49.Aset.Rpt.Rpt.BUKUBRGTR.rpt", CS, Params);
      }
      else
      {
        ...
        pdfurl = ReportUtils.ExportExcel("Usadi.Valid49.Aset.Rpt.Rpt.BUKUBRGTR.rpt", CS, Params);
      } 
      return pdfurl;
    }
