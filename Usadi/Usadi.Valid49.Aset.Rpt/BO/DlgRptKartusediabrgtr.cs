...
{
  #region Usadi.Valid49.BO.DlgRptKartusediabrgtrControl, Usadi.Valid49.Aset.Rpt
  [Serializable]
  public class DlgRptKartusediabrgtrControl : DaftunitControl, IDataControlUIEntry, IPrintable
  {
    ...
    public DlgRptKartusediabrgtrControl()
    {
    ...
    public override HashTableofParameterRow GetEntries()
    {
      ...
      hpars.Add(DaftasetPersediaanLookupControl.Instance.GetLookupParameterRow(this, false).SetEnable(enableFilter));
      hpars.Add(new ParameterRowDate(this, ConstantDict.GetColumnTitle("Tanggal=Tanggal"), true).SetEnable(true));
      return hpars;
    }
    ...
    public string GetURLReport(int n)
    {
      ...
      CS[ReportUtils.RPTNAME] = "KARTUSEDIABRGTR.rpt";
      CS[ReportUtils.PDFNAME] = "KARTUSEDIABRGTR_" + (string)GlobalAsp.GetSessionUser().GetValue("Userid") + "_" + DateTime.Now.ToString("yyyyMMddHHmmss") + ".pdf";
      ...
      if(n == 0)
      {
        pdfurl = ReportUtils.ExportPDF("Usadi.Valid49.Aset.Rpt.Rpt.KARTUSEDIABRGTR.rpt", CS, Params);
      }
      else
      {
        CS[ReportUtils.PDFNAME] = "KARTUSEDIABRGTR_" + (string)GlobalAsp.GetSessionUser().GetValue("Userid") + "_" + DateTime.Now.ToString("yyyyMMddHHmmss") + ".xls";
        pdfurl = ReportUtils.ExportExcel("Usadi.Valid49.Aset.Rpt.Rpt.KARTUSEDIABRGTR.rpt", CS, Params);
      } 
      return pdfurl;
    }
