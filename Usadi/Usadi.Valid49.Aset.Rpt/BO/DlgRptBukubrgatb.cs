...
{
  #region Usadi.Valid49.BO.DlgRptBukubrgatbControl, Usadi.Valid49.Aset.Rpt
  [Serializable]
  public class DlgRptBukubrgatbControl : DaftunitControl, IDataControlUIEntry, IPrintable
  {
    ...
    public DlgRptBukubrgatbControl()
    {
    ...
    public string GetURLReport(int n)
    {
      ...
      CS[ReportUtils.RPTNAME] = "BukuBrgATB.rpt";
      CS[ReportUtils.PDFNAME] = "BukuBrgATB_" + (string)GlobalAsp.GetSessionUser().GetValue("Userid") + "_" + DateTime.Now.ToString("yyyyMMddHHmmss") + ".pdf";
      ...
      string pdfurl = ReportUtils.ExportPDF("Usadi.Valid49.Aset.Rpt.Rpt.BukuBrgATB.rpt", CS, Params);
      return pdfurl;
    }
    ...
    {
      RptPars rptPar = new RptPars() { Title = " Buku ATB", RptClass = LinkPdf };
