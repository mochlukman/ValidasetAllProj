...
{
  #region Usadi.Valid49.BO.DlgRptPenguranganreklasControl, Usadi.Valid49.Aset.Rpt
  [Serializable]
  public class DlgRptPenguranganreklasControl : DaftunitControl, IDataControlUIEntry, IPrintable
  {
    ...
    public DlgRptPenguranganreklasControl()
    {
    ...
    public string GetURLReport(int n)
    {
      ...
      CS[ReportUtils.RPTNAME] = "PENGURANGAN_REKLAS.rpt";
      CS[ReportUtils.PDFNAME] = "PENGURANGAN_REKLAS_" + (string)GlobalAsp.GetSessionUser().GetValue("Userid") + "_" + DateTime.Now.ToString("yyyyMMddHHmmss") + ".pdf";
      ...
      string pdfurl = ReportUtils.ExportPDF("Usadi.Valid49.Aset.Rpt.Rpt.PENGURANGAN_REKLAS.rpt", CS, Params);
      return pdfurl;
    }
    ...
    {
      RptPars rptPar = new RptPars() { Title = "Laporan Pengurangan Reklasifikasi BMD", RptClass = LinkPdf };
  ...
  #endregion DlgRptDlgRptPenguranganreklas
}
