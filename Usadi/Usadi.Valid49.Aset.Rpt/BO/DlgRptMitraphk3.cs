...
{
  #region Usadi.Valid49.BO.DlgRptMitraphk3Control, Usadi.Valid49.Aset.Rpt
  [Serializable]
  public class DlgRptMitraphk3Control : DaftunitControl, IDataControlUIEntry, IPrintable
  {
    ...
    public string GetURLReport(int n)
    {
      ...
      CS[ReportUtils.RPTNAME] = "MITRAPHK3.rpt";
      CS[ReportUtils.PDFNAME] = "MITRAPHK3_" + (string)GlobalAsp.GetSessionUser().GetValue("Userid") + "_" + DateTime.Now.ToString("yyyyMMddHHmmss") + ".pdf";
      ...
      string pdfurl = ReportUtils.ExportPDF("Usadi.Valid49.Aset.Rpt.Rpt.MITRAPHK3.rpt", CS, Params);
      return pdfurl;
    }
    ...
    {
      RptPars rptPar = new RptPars() { Title = "KEMITRAAN", RptClass = LinkPdf };
