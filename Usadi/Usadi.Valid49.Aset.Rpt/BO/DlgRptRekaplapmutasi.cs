...
namespace Usadi.Valid49.BO
{
  ...
  [Serializable]
  public class DlgRptRekaplapmutasiControl : DaftunitControl, IDataControlUIEntry, IPrintable
  {
    ...
    public DlgRptRekaplapmutasiControl()
    {
    ...
    public string GetURLReport(int n)
    {
      ...
      CS[ReportUtils.RPTNAME] = "LAPMUTASI.rpt";
      CS[ReportUtils.PDFNAME] = "LAPMUTASI_" + (string)GlobalAsp.GetSessionUser().GetValue("Userid") + "_" + DateTime.Now.ToString("yyyyMMddHHmmss") + ".pdf";
      ...
      if(n == 0)
      {
        pdfurl = ReportUtils.ExportPDF("Usadi.Valid49.Aset.Rpt.Rpt.LAPMUTASI.rpt", CS, Params);
      }
      else
      {
        CS[ReportUtils.PDFNAME] = "LAPMUTASI_" + (string)GlobalAsp.GetSessionUser().GetValue("Userid") + "_" + DateTime.Now.ToString("yyyyMMddHHmmss") + ".xls";
        pdfurl = ReportUtils.ExportExcel("Usadi.Valid49.Aset.Rpt.Rpt.LAPMUTASI.rpt", CS, Params);
      } 
      return pdfurl;
    }
  ...
  #endregion DlgRptRekaplapmutasi
}
