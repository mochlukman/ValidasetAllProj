...
{
  #region Usadi.Valid49.BO.DlgRptKertaskerjakibbControl, Usadi.Valid49.Aset.Rpt
  [Serializable]
  public class DlgRptKertaskerjakibbControl : DaftunitControl, IDataControlUIEntry, IPrintable
  {
    ...
    public DlgRptKertaskerjakibbControl()
    {
    ...
    public string GetURLReport(int n)
    {
      ...
      CS[ReportUtils.RPTNAME] = "KERTASKERJA_KIBB.rpt";
      CS[ReportUtils.PDFNAME] = "KERTASKERJA_KIBB_" + (string)GlobalAsp.GetSessionUser().GetValue("Userid") + "_" + DateTime.Now.ToString("yyyyMMddHHmmss") + ".pdf";
      ...
      if(n == 0)
      {
        pdfurl = ReportUtils.ExportPDF("Usadi.Valid49.Aset.Rpt.Rpt.KERTASKERJA_KIBB.rpt", CS, Params);
      }
      else
      {
        CS[ReportUtils.PDFNAME] = "KERTASKERJA_KIBB_" + (string)GlobalAsp.GetSessionUser().GetValue("Userid") + "_" + DateTime.Now.ToString("yyyyMMddHHmmss") + ".xls";
        pdfurl = ReportUtils.ExportExcel("Usadi.Valid49.Aset.Rpt.Rpt.KERTASKERJA_KIBB.rpt", CS, Params);
      } 
      return pdfurl;
    }
  ...
  #endregion DlgRptKertaskerjakibb
}
