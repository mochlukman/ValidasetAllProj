...
{
  #region Usadi.Valid49.BO.DlgRptRekapPersediaanrusakControl, Usadi.Valid49.Aset.Rpt
  [Serializable]
  public class DlgRptRekapPersediaanrusakControl : DaftunitControl, IDataControlUIEntry, IPrintable
  {
    ...
    public DlgRptRekapPersediaanrusakControl()
    {
    ...
    public override HashTableofParameterRow GetEntries()
    {
      ...
      hpars.Add(DaftasetRusakberatRptLookupControl.Instance.GetLookupParameterRow(this, false).SetEnable(enableFilter));
      ...
      hpars.Add(new ParameterRow(ConstantDict.GetColumnTitleEntry("Subunit=Subunit"), ParameterRow.MODE_SELECT,
        list, "Kdpar=Nmpar", 30).SetEnable(enableFilter));
    ...
    public string GetURLReport(int n)
    {
      ...
      CS[ReportUtils.RPTNAME] = "ASETLANCARRB_REKAP.rpt";
      CS[ReportUtils.PDFNAME] = "ASETLANCARRB_REKAP_" + (string)GlobalAsp.GetSessionUser().GetValue("Userid") + "_" + DateTime.Now.ToString("yyyyMMddHHmmss") + ".pdf";
      ...
      //string pdfurl = ReportUtils.ExportPDF("Usadi.Valid49.Aset.Rpt.Rpt.KOREKSI.rpt", CS, Params);
      //return pdfurl;
      string pdfurl;
      if (n == 0)
      {
        pdfurl = ReportUtils.ExportPDF("Usadi.Valid49.Aset.Rpt.Rpt.ASETLANCARRB_REKAP.rpt", CS, Params);
      }
      else
      {
        CS[ReportUtils.PDFNAME] = "ASETLANCARRB_REKAP_" + (string)GlobalAsp.GetSessionUser().GetValue("Userid") + "_" + DateTime.Now.ToString("yyyyMMddHHmmss") + ".xls";
        pdfurl = ReportUtils.ExportExcel("Usadi.Valid49.Aset.Rpt.Rpt.ASETLANCARRB_REKAP.rpt", CS, Params);
      }
      return pdfurl;
    }
