...
{
  #region Usadi.Valid49.BO.DlgRptKIBmitraControl, Usadi.Valid49.Aset.Rpt
  [Serializable]
  public class DlgRptKIBmitraControl : DaftunitControl, IDataControlUIEntry, IPrintable
  {
    ...
    public string GetURLReport(int n)
    {
      ...
      CS[ReportUtils.RPTNAME] = "KIBMITRA.rpt";
      CS[ReportUtils.PDFNAME] = "KIBMITRA_" + (string)GlobalAsp.GetSessionUser().GetValue("Userid") + "_" + DateTime.Now.ToString("yyyyMMddHHmmss") + ".pdf";
      ...
      if(n == 0)
      {
        pdfurl = ReportUtils.ExportPDF("Usadi.Valid49.Aset.Rpt.Rpt.KIBMITRA.rpt", CS, Params);
      }
      else
      {
        CS[ReportUtils.PDFNAME] = "KIBMITRA_" + (string)GlobalAsp.GetSessionUser().GetValue("Userid") + "_" + DateTime.Now.ToString("yyyyMMddHHmmss") + ".xls";
        pdfurl = ReportUtils.ExportExcel("Usadi.Valid49.Aset.Rpt.Rpt.KIBMITRA.rpt", CS, Params);
      } 
      return pdfurl;
    }
