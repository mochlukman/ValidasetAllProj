...
{
  #region Usadi.Valid49.BO.DlgRptKertaskerjakibdControl, Usadi.Valid49.Aset.Rpt
  [Serializable]
  public class DlgRptKertaskerjakibdControl : DaftunitControl, IDataControlUIEntry, IPrintable
  {
    ...
    public DlgRptKertaskerjakibdControl()
    {
    ...
    public string GetURLReport(int n)
    {
      ...
      CS[ReportUtils.RPTNAME] = "KERTASKERJA_KIBD.rpt";
      CS[ReportUtils.PDFNAME] = "KERTASKERJA_KIBD_" + (string)GlobalAsp.GetSessionUser().GetValue("Userid") + "_" + DateTime.Now.ToString("yyyyMMddHHmmss") + ".pdf";
      ...
      if(n == 0)
      {
        pdfurl = ReportUtils.ExportPDF("Usadi.Valid49.Aset.Rpt.Rpt.KERTASKERJA_KIBD.rpt", CS, Params);
      }
      else
      {
        CS[ReportUtils.PDFNAME] = "KERTASKERJA_KIBD_" + (string)GlobalAsp.GetSessionUser().GetValue("Userid") + "_" + DateTime.Now.ToString("yyyyMMddHHmmss") + ".xls";
        pdfurl = ReportUtils.ExportExcel("Usadi.Valid49.Aset.Rpt.Rpt.KERTASKERJA_KIBD.rpt", CS, Params);
      } 
      return pdfurl;
    }
  ...
  #endregion DlgRptKertaskerjakibd
}
