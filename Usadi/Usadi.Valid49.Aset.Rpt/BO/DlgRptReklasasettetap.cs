...
{
  #region Usadi.Valid49.BO.DlgRptReklasasettetapControl, Usadi.Valid49.Aset.Rpt
  [Serializable]
  public class DlgRptReklasasettetapControl : DaftunitControl, IDataControlUIEntry, IPrintable
  {
    ...
    public DlgRptReklasasettetapControl()
    {
    ...
    public override HashTableofParameterRow GetEntries()
    {
      ...
      hpars.Add(DaftasetLookupControl.Instance.GetLookupParameterRow(this, false).SetEnable(enableFilter));
    ...
    public string GetURLReport(int n)
    {
      ...
      CS[ReportUtils.RPTNAME] = "RINCREKLAS_ASETTETAP.rpt";
      CS[ReportUtils.PDFNAME] = "RINCREKLAS_ASETTETAP_" + (string)GlobalAsp.GetSessionUser().GetValue("Userid") + "_" + DateTime.Now.ToString("yyyyMMddHHmmss") + ".pdf";
      ...
      if(n == 0)
      {
        pdfurl = ReportUtils.ExportPDF("Usadi.Valid49.Aset.Rpt.Rpt.RINCREKLAS_ASETTETAP.rpt", CS, Params);
      }
      else
      {
        CS[ReportUtils.PDFNAME] = "RINCREKLAS_ASETTETAP_" + (string)GlobalAsp.GetSessionUser().GetValue("Userid") + "_" + DateTime.Now.ToString("yyyyMMddHHmmss") + ".xls";
        pdfurl = ReportUtils.ExportExcel("Usadi.Valid49.Aset.Rpt.Rpt.RINCREKLAS_ASETTETAP.rpt", CS, Params);
      } 
      return pdfurl;
    }
  ...
  #endregion DlgRptReklasasettetap
}
