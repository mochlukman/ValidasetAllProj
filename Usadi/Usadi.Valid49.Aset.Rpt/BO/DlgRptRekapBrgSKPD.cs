...
{
  #region Usadi.Valid49.BO.DlgRptRekapBrgSKPDControl, Usadi.Valid49.Aset.Rpt
  [Serializable]
  public class DlgRptRekapBrgSKPDControl : DaftunitControl, IDataControlUIEntry, IPrintable
  {
    ...
    public DlgRptRekapBrgSKPDControl()
    {
