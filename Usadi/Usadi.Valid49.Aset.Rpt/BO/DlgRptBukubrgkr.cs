...
{
  #region Usadi.Valid49.BO.DlgRptBukubrgkrControl, Usadi.Valid49.Aset.Rpt
  [Serializable]
  public class DlgRptBukubrgkrControl : DaftunitControl, IDataControlUIEntry, IPrintable
  {
    ...
    public string GetURLReport(int n)
    {
      ...
      CS[ReportUtils.RPTNAME] = "BUKUBRGKR.rpt";
      CS[ReportUtils.PDFNAME] = "BUKUBRGKR_" + (string)GlobalAsp.GetSessionUser().GetValue("Userid") + "_" + DateTime.Now.ToString("yyyyMMddHHmmss") + ".pdf";
      ...
      if(n == 0)
      {
        pdfurl = ReportUtils.ExportPDF("Usadi.Valid49.Aset.Rpt.Rpt.BUKUBRGKR.rpt", CS, Params);
      }
      else
      {
        ...
        pdfurl = ReportUtils.ExportExcel("Usadi.Valid49.Aset.Rpt.Rpt.BUKUBRGKR.rpt", CS, Params);
      } 
      return pdfurl;
    }
