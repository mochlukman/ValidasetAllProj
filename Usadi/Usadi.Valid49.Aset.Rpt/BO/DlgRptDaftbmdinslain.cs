...
{
  #region Usadi.Valid49.BO.DlgRptDaftbmdinslainControl, Usadi.Valid49.Aset.Rpt
  [Serializable]
  public class DlgRptDaftbmdinslainControl : DaftunitControl, IDataControlUIEntry, IPrintable
  {
    ...
    public DlgRptDaftbmdinslainControl()
    {
    ...
    public string GetURLReport(int n)
    {
      ...
      CS[ReportUtils.RPTNAME] = "DAFTBMD_INSLAIN.rpt";
      CS[ReportUtils.PDFNAME] = "DAFTBMD_INSLAIN_" + (string)GlobalAsp.GetSessionUser().GetValue("Userid") + "_" + DateTime.Now.ToString("yyyyMMddHHmmss") + ".pdf";
      ...
      string pdfurl = ReportUtils.ExportPDF("Usadi.Valid49.Aset.Rpt.Rpt.DAFTBMD_INSLAIN.rpt", CS, Params);
      return pdfurl;
    }
    ...
    {
      RptPars rptPar = new RptPars() { Title = "DAFT BMD PINJAM PAKAI", RptClass = LinkPdf };
  ...
  #endregion DlgRptDaftbmdinslain
}
