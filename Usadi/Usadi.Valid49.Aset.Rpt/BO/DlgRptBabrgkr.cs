...
{
  #region Usadi.Valid49.BO.DlgRptBabrgkrControl, Usadi.Valid49.Aset.Rpt
  [Serializable]
  public class DlgRptBabrgkrControl : DaftunitControl, IDataControlUIEntry, IPrintable
  {
    ...
    public override HashTableofParameterRow GetEntries()
    {
      ...
      hpars.Add(InvbastLookupControl.Instance.GetLookupParameterRow(this, false).SetEnable(enableFilter));
    ...
    public string GetURLReport(int n)
    {
      ...
      CS[ReportUtils.RPTNAME] = "BABRGKR.rpt";
      CS[ReportUtils.PDFNAME] = "BABRGKR_" + (string)GlobalAsp.GetSessionUser().GetValue("Userid") + "_" + DateTime.Now.ToString("yyyyMMddHHmmss") + ".pdf";

      Hashtable Params = new Hashtable();
      Params["@unitkey"] = Unitkey;
      Params["@nobast"] = Nobast;
      ...
      if(n == 0)
      {
        pdfurl = ReportUtils.ExportPDF("Usadi.Valid49.Aset.Rpt.Rpt.BABRGKR.rpt", CS, Params);
      }
      else
      {
        CS[ReportUtils.PDFNAME] = "BABRGKR_" + (string)GlobalAsp.GetSessionUser().GetValue("Userid") + "_" + DateTime.Now.ToString("yyyyMMddHHmmss") + ".xls";
        pdfurl = ReportUtils.ExportExcel("Usadi.Valid49.Aset.Rpt.Rpt.BABRGKR.rpt", CS, Params);
      } 
      return pdfurl;
    }
