...
{
  #region Usadi.Valid49.BO.DlgRptKoreksiControl, Usadi.Valid49.Aset.Rpt
  [Serializable]
  public class DlgRptKoreksiControl : DaftunitControl, IDataControlUIEntry, IPrintable
  {
    ...
    public string GetURLReport(int n)
    {
      ...
      CS[ReportUtils.RPTNAME] = "KOREKSI.rpt";
      CS[ReportUtils.PDFNAME] = "KOREKSI_" + (string)GlobalAsp.GetSessionUser().GetValue("Userid") + "_" + DateTime.Now.ToString("yyyyMMddHHmmss") + ".pdf";
      ...
      if (n == 0)
      {
        pdfurl = ReportUtils.ExportPDF("Usadi.Valid49.Aset.Rpt.Rpt.KOREKSI.rpt", CS, Params);
      }
      else
      {
        CS[ReportUtils.PDFNAME] = "KOREKSI_" + (string)GlobalAsp.GetSessionUser().GetValue("Userid") + "_" + DateTime.Now.ToString("yyyyMMddHHmmss") + ".xls";
        pdfurl = ReportUtils.ExportExcel("Usadi.Valid49.Aset.Rpt.Rpt.KOREKSI.rpt", CS, Params);
      }
      return pdfurl;
    }
