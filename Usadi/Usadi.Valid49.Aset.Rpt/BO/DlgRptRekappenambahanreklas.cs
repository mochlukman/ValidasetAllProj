...
{
  #region Usadi.Valid49.BO.DlgRptRekappenambahanreklasControl, Usadi.Valid49.Aset.Rpt
  [Serializable]
  public class DlgRptRekappenambahanreklasControl : DaftunitControl, IDataControlUIEntry, IPrintable
  {
    ...
    public DlgRptRekappenambahanreklasControl()
    {
    ...
    public string GetURLReport(int n)
    {
      ...
      CS[ReportUtils.RPTNAME] = "REKAPPENAMBAHAN_REKLAS.rpt";
      CS[ReportUtils.PDFNAME] = "REKAPPENAMBAHAN_REKLAS_" + (string)GlobalAsp.GetSessionUser().GetValue("Userid") + "_" + DateTime.Now.ToString("yyyyMMddHHmmss") + ".pdf";
      ...
      string pdfurl = ReportUtils.ExportPDF("Usadi.Valid49.Aset.Rpt.Rpt.REKAPPENAMBAHAN_REKLAS.rpt", CS, Params);
      return pdfurl;
    }
    ...
    {
      RptPars rptPar = new RptPars() { Title = "Rekapitulasi Penambahan Reklasifikasi BMD", RptClass = LinkPdf };
