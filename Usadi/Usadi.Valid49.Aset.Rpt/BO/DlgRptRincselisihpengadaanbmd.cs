...
{
  #region Usadi.Valid49.BO.DlgRptRincselisihpengadaanbmdControl, Usadi.Valid49.Aset.Rpt
  [Serializable]
  public class DlgRptRincselisihpengadaanbmdControl : DaftunitControl, IDataControlUIEntry, IPrintable
  {
    ...
    public string GetURLReport(int n)
    {
      ...
      CS[ReportUtils.RPTNAME] = "REKAPRINCSELISIH_ASETTETAPINTRA.rpt";
      CS[ReportUtils.PDFNAME] = "REKAPRINCSELISIH_ASETTETAPINTRA_" + (string)GlobalAsp.GetSessionUser().GetValue("Userid") + "_" + DateTime.Now.ToString("yyyyMMddHHmmss") + ".pdf";
      ...
      //string pdfurl = ReportUtils.ExportPDF("Usadi.Valid49.Aset.Rpt.Rpt.REKAPRINCSELISIH_ASETTETAPINTRA.rpt", CS, Params);
      string pdfurl;
      if (n == 0)
      {
        pdfurl = ReportUtils.ExportPDF("Usadi.Valid49.Aset.Rpt.Rpt.REKAPRINCSELISIH_ASETTETAPINTRA.rpt", CS, Params);
      }
      else
      {
        CS[ReportUtils.PDFNAME] = "REKAPRINCSELISIH_ASETTETAPINTRA_" + (string)GlobalAsp.GetSessionUser().GetValue("Userid") + "_" + DateTime.Now.ToString("yyyyMMddHHmmss") + ".xls";
        pdfurl = ReportUtils.ExportExcel("Usadi.Valid49.Aset.Rpt.Rpt.REKAPRINCSELISIH_ASETTETAPINTRA.rpt", CS, Params);
      }
      return pdfurl;
    }
  ...
  #endregion DlgRptRincselisihpengadaanbmd
}
