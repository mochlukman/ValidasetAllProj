...
{
  #region Usadi.Valid49.BO.DlgRptAppraisalControl, Usadi.Valid49.Aset.Rpt
  [Serializable]
  public class DlgRptAppraisalControl : DaftunitControl, IDataControlUIEntry, IPrintable
  {
    ...
    public string GetURLReport(int n)
    {
      ...
      CS[ReportUtils.RPTNAME] = "APPRAISAL.rpt";
      CS[ReportUtils.PDFNAME] = "APPRAISAL_" + (string)GlobalAsp.GetSessionUser().GetValue("Userid") + "_" + DateTime.Now.ToString("yyyyMMddHHmmss") + ".pdf";
      ...
      string pdfurl = ReportUtils.ExportPDF("Usadi.Valid49.Aset.Rpt.Rpt.APPRAISAL.rpt", CS, Params);
      return pdfurl;
    }
    ...
    {
      RptPars rptPar = new RptPars() { Title = "APPRAISAL", RptClass = LinkPdf };
