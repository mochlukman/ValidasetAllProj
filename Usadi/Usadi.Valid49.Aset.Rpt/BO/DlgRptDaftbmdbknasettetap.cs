...
{
  #region Usadi.Valid49.BO.DlgRptDaftbmdbknasettetapControl, Usadi.Valid49.Aset.Rpt
  [Serializable]
  public class DlgRptDaftbmdbknasettetapControl : DaftunitControl, IDataControlUIEntry, IPrintable
  {
    ...
    public DlgRptDaftbmdbknasettetapControl()
    {
    ...
    public string GetURLReport(int n)
    {
      ...
      CS[ReportUtils.RPTNAME] = "DAFTBMD_BKNASETTETAP.rpt";
      CS[ReportUtils.PDFNAME] = "DAFTBMD_BKNASETTETAP_" + (string)GlobalAsp.GetSessionUser().GetValue("Userid") + "_" + DateTime.Now.ToString("yyyyMMddHHmmss") + ".pdf";
      ...
      string pdfurl = ReportUtils.ExportPDF("Usadi.Valid49.Aset.Rpt.Rpt.DAFTBMD_BKNASETTETAP.rpt", CS, Params);
      return pdfurl;
    }
    ...
    {
      RptPars rptPar = new RptPars() { Title = "DAFT BMD BKN ASET TETAP", RptClass = LinkPdf };
  ...
  #endregion DlgRptDaftbmdbknasettetap
}
