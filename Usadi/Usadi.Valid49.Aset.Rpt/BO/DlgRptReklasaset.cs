...
{
  #region Usadi.Valid49.BO.DlgRptReklasasetControl, Usadi.Valid49.Aset.Rpt
  [Serializable]
  public class DlgRptReklasasetControl : DaftunitControl, IDataControlUIEntry, IPrintable
  {
    ...
    #endregion
    public DlgRptReklasasetControl()
    {
    ...
    public string GetURLReport(int n)
    {
      ...
      CS[ReportUtils.RPTNAME] = "RINCREKLAS_01.rpt";
      CS[ReportUtils.PDFNAME] = "RINCREKLAS_01_" + (string)GlobalAsp.GetSessionUser().GetValue("Userid") + "_" + DateTime.Now.ToString("yyyyMMddHHmmss") + ".pdf";
      ...
      string pdfurl = ReportUtils.ExportPDF("Usadi.Valid49.Aset.Rpt.Rpt.RINCREKLAS_01.rpt", CS, Params);
      return pdfurl;
    }
    ...
    {
      RptPars rptPar = new RptPars() { Title = "REKLAS JENIS ASET", RptClass = LinkPdf };
