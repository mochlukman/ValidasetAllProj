...
{
  #region Usadi.Valid49.BO.DlgRptKertaskerjakibaControl, Usadi.Valid49.Aset.Rpt
  [Serializable]
  public class DlgRptKertaskerjakibaControl : DaftunitControl, IDataControlUIEntry, IPrintable
  {
    ...
    public DlgRptKertaskerjakibaControl()
    {
    ...
    public string GetURLReport(int n)
    {
      ...
      CS[ReportUtils.RPTNAME] = "KERTASKERJA_KIBA.rpt";
      CS[ReportUtils.PDFNAME] = "KERTASKERJA_KIBA_" + (string)GlobalAsp.GetSessionUser().GetValue("Userid") + "_" + DateTime.Now.ToString("yyyyMMddHHmmss") + ".pdf";
      ...
      if(n == 0)
      {
        pdfurl = ReportUtils.ExportPDF("Usadi.Valid49.Aset.Rpt.Rpt.KERTASKERJA_KIBA.rpt", CS, Params);
      }
      else
      {
        CS[ReportUtils.PDFNAME] = "KERTASKERJA_KIBA_" + (string)GlobalAsp.GetSessionUser().GetValue("Userid") + "_" + DateTime.Now.ToString("yyyyMMddHHmmss") + ".xls";
        pdfurl = ReportUtils.ExportExcel("Usadi.Valid49.Aset.Rpt.Rpt.KERTASKERJA_KIBA.rpt", CS, Params);
      } 
      return pdfurl;
    }
  ...
  #endregion DlgRptKertaskerjakiba
}
