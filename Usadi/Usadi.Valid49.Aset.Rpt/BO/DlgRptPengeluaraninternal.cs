...
{
  #region Usadi.Valid49.BO.DlgRptPengeluaraninternalControl, Usadi.Valid49.Aset.Rpt
  [Serializable]
  public class DlgRptPengeluaraninternalControl : DaftunitControl, IDataControlUIEntry, IPrintable
  {
    ...
    public DlgRptPengeluaraninternalControl()
    {
    ...
    public string GetURLReport(int n)
    {
      ...
      CS[ReportUtils.RPTNAME] = "PENGELUARAN_INTERNAL.rpt";
      CS[ReportUtils.PDFNAME] = "PENGELUARAN_INTERNAL_" + (string)GlobalAsp.GetSessionUser().GetValue("Userid") + "_" + DateTime.Now.ToString("yyyyMMddHHmmss") + ".pdf";
      ...
      string pdfurl = ReportUtils.ExportPDF("Usadi.Valid49.Aset.Rpt.Rpt.PENGELUARAN_INTERNAL.rpt", CS, Params);
      return pdfurl;
    }
  ...
  #endregion DlgRptPengeluaraninternal
}
