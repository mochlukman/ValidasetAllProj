...
{
  #region Usadi.Valid49.BO.DlgRptKibareControl, Usadi.Valid49.Aset.Rpt
  [Serializable]
  public class DlgRptKibareControl : KibeControl, IDataControlUIEntry, IPrintable
  {
    ...
    public string GetURLReport(int n)
    {
      ...
      CS[ReportUtils.RPTNAME] = "KIBARE.rpt";
      CS[ReportUtils.PDFNAME] = "KIBARE_" + (string)GlobalAsp.GetSessionUser().GetValue("Userid") + "_" + DateTime.Now.ToString("yyyyMMddHHmmss") + ".pdf";
      ...
      if (n == 0)
      {
        pdfurl = ReportUtils.ExportPDF("Usadi.Valid49.Aset.Rpt.Rpt.KIBARE.rpt", CS, Params);
      }
      else
      {
        CS[ReportUtils.PDFNAME] = "KIBARE_" + (string)GlobalAsp.GetSessionUser().GetValue("Userid") + "_" + DateTime.Now.ToString("yyyyMMddHHmmss") + ".xls";
        pdfurl = ReportUtils.ExportExcel("Usadi.Valid49.Aset.Rpt.Rpt.KIBARE.rpt", CS, Params);
      }
      return pdfurl;
    }
