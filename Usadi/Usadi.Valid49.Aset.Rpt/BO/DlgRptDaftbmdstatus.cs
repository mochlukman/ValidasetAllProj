...
{
  #region Usadi.Valid49.BO.DlgRptDaftbmdstatusControl, Usadi.Valid49.Aset.Rpt
  [Serializable]
  public class DlgRptDaftbmdstatusControl : DaftunitControl, IDataControlUIEntry, IPrintable
  {
    ...
    public DlgRptDaftbmdstatusControl()
    {
    ...
    public override HashTableofParameterRow GetEntries()
    {
      ...
      hpars.Add(DaftasetLookupControl.Instance.GetLookupParameterRow(this, false));
    ...
    public string GetURLReport(int n)
    {
      ...
      CS[ReportUtils.RPTNAME] = "DAFTBMD_STATUS.rpt";
      CS[ReportUtils.PDFNAME] = "DAFTBMD_STATUS_" + (string)GlobalAsp.GetSessionUser().GetValue("Userid") + "_" + DateTime.Now.ToString("yyyyMMddHHmmss") + ".pdf";
      ...
      if(n == 0)
      {
        pdfurl = ReportUtils.ExportPDF("Usadi.Valid49.Aset.Rpt.Rpt.DAFTBMD_STATUS.rpt", CS, Params);
      }
      else
      {
        CS[ReportUtils.PDFNAME] = "DAFTBMD_STATUS_" + (string)GlobalAsp.GetSessionUser().GetValue("Userid") + "_" + DateTime.Now.ToString("yyyyMMddHHmmss") + ".xls";
        pdfurl = ReportUtils.ExportExcel("Usadi.Valid49.Aset.Rpt.Rpt.DAFTBMD_STATUS.rpt", CS, Params);
      } 
      return pdfurl;
    }
