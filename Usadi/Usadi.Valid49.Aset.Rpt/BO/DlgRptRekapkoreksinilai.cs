...
{
  #region Usadi.Valid49.BO.DlgRptRekapkoreksinilaiControl, Usadi.Valid49.Aset.Rpt
  [Serializable]
  public class DlgRptRekapkoreksinilaiControl : DaftunitControl, IDataControlUIEntry, IPrintable
  {
    ...
    public DlgRptRekapkoreksinilaiControl()
    {
    ...
    public string GetURLReport(int n)
    {
      ...
      CS[ReportUtils.RPTNAME] = "REKAPKOREKSINILAI.rpt";
      CS[ReportUtils.PDFNAME] = "REKAPKOREKSINILAI_" + (string)GlobalAsp.GetSessionUser().GetValue("Userid") + "_" + DateTime.Now.ToString("yyyyMMddHHmmss") + ".pdf";
      ...
      string pdfurl = ReportUtils.ExportPDF("Usadi.Valid49.Aset.Rpt.Rpt.REKAPKOREKSINILAI.rpt", CS, Params);
      return pdfurl;
    }
    ...
    {
      RptPars rptPar = new RptPars() { Title = "Laporan Koreksi Nilai ", RptClass = LinkPdf };
