...
{
  #region Usadi.Valid49.BO.DlgRptRincbelanjabrgControl, Usadi.Valid49.Aset.Rpt
  [Serializable]
  public class DlgRptRincbelanjabrgControl : DaftunitControl, IDataControlUIEntry, IPrintable
  {
    ...
    #endregion 
    public DlgRptRincbelanjabrgControl()
    {
    ...
    public string GetURLReport(int n)
    {
      ...
      CS[ReportUtils.RPTNAME] = "RINCIAN_BELANJABRG.rpt";
      CS[ReportUtils.PDFNAME] = "RINCIAN_BELANJABRG_" + (string)GlobalAsp.GetSessionUser().GetValue("Userid") + "_" + DateTime.Now.ToString("yyyyMMddHHmmss") + ".pdf";
      ...
      string pdfurl = ReportUtils.ExportPDF("Usadi.Valid49.Aset.Rpt.Rpt.RINCIAN_BELANJABRG.rpt", CS, Params);
      return pdfurl;
    }
    ...
    {
      RptPars rptPar = new RptPars() { Title = "RINCIAN BELANJA BRG", RptClass = LinkPdf };
  ...
  #endregion DlgRptRincbelanjabrg
}
