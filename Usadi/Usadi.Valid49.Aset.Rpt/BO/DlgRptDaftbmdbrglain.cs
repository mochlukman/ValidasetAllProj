...
{
  #region Usadi.Valid49.BO.DlgRptDaftbmdbrglainControl, Usadi.Valid49.Aset.Rpt
  [Serializable]
  public class DlgRptDaftbmdbrglainControl : DaftunitControl, IDataControlUIEntry, IPrintable
  {
    ...
    public DlgRptDaftbmdbrglainControl()
    {
    ...
    public string GetURLReport(int n)
    {
      ...
      CS[ReportUtils.RPTNAME] = "DAFTBMD_BRGLAIN.rpt";
      CS[ReportUtils.PDFNAME] = "DAFTBMD_BRGLAIN_" + (string)GlobalAsp.GetSessionUser().GetValue("Userid") + "_" + DateTime.Now.ToString("yyyyMMddHHmmss") + ".pdf";
      ...
      string pdfurl = ReportUtils.ExportPDF("Usadi.Valid49.Aset.Rpt.Rpt.DAFTBMD_BRGLAIN.rpt", CS, Params);
      return pdfurl;
    }
    ...
    {
      RptPars rptPar = new RptPars() { Title = "DAFT BMD BGR LAIN", RptClass = LinkPdf };
  ...
  #endregion DlgRptDaftbmdbrglain
}
