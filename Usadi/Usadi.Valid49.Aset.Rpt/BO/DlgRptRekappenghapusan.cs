...
{
  #region Usadi.Valid49.BO.DlgRptRekappenghapusanControl, Usadi.Valid49.Aset.Rpt
  [Serializable]
  public class DlgRptRekappenghapusanControl : DaftunitControl, IDataControlUIEntry, IPrintable
  {
    ...
    public DlgRptRekappenghapusanControl()
    {
    ...
    public string GetURLReport(int n)
    {
      ...
      CS[ReportUtils.RPTNAME] = $"REKAPPENGHAPUSAN_PEMINDAHTANGANAN_{StrMode}.rpt";
      ...
      string cname = "Usadi.Valid49.Aset.Rpt.Rpt.REKAPPENGHAPUSAN_PEMINDAHTANGANAN.rpt";
      if (!StrMode.Equals("default"))
      {
  ...
  #endregion DlgRptRekappenghapusan
}
