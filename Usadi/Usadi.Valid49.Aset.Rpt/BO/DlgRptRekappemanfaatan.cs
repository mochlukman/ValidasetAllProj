...
{
  #region Usadi.Valid49.BO.DlgRptRekappemanfaatanControl, Usadi.Valid49.Aset.Rpt
  [Serializable]
  public class DlgRptRekappemanfaatanControl : DaftunitControl, IDataControlUIEntry, IPrintable
  {
    ...
    public DlgRptRekappemanfaatanControl()
    {
    ...
    public override HashTableofParameterRow GetEntries()
    {
      ...
      hpars.Add(new ParameterRowSelect(ConstantDict.GetColumnTitle("Kdtans=Jenis"),
        GetList(new JtransManfaatLookupControl()), "Kdtans=Nmtrans", 54).SetEnable(enableFilter));
    ...
    public string GetURLReport(int n)
    {
      ...
      CS[ReportUtils.RPTNAME] = "REKAPPEMANFAATAN.rpt";
      CS[ReportUtils.PDFNAME] = "REKAPPEMANFAATAN_" + (string)GlobalAsp.GetSessionUser().GetValue("Userid") + "_" + DateTime.Now.ToString("yyyyMMddHHmmss") + ".pdf";


      Hashtable Params = new Hashtable();
      Params["@unitkey"] = Unitkey;
      Params["@Kdklas"] = Kdklas;
      Params["@Kdmanfaat"] = Kdtans;
      Params["@tglawal"] = Tglawal; //Tgl1;   //Tglawal;
      Params["@tglakhir"] = Tglakhir; //Tgl2; //Tglakhir;
      Params["@subunit"] = Subunit;


      string pdfurl = ReportUtils.ExportPDF("Usadi.Valid49.Aset.Rpt.Rpt.REKAPPEMANFAATAN.rpt", CS, Params);
      return pdfurl;
    }
    ...
    {
      RptPars rptPar = new RptPars() { Title = "Rekapitulasi Laporan Pemanfaatan Pemda", RptClass = LinkPdf };
  ...
  #endregion DlgRptRekappemanfaatan
}
