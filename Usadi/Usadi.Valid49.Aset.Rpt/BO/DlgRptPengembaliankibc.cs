...
{
  #region Usadi.Valid49.BO.DlgRptPengembaliankibcControl, Usadi.Valid49.Aset.Rpt
  [Serializable]
  public class DlgRptPengembaliankibcControl : DaftunitControl, IDataControlUIEntry, IPrintable
  {
    ...
    public DlgRptPengembaliankibcControl()
    {
    ...
    public string GetURLReport(int n)
    {
      ...
      CS[ReportUtils.RPTNAME] = "PENGEMBALIANKIBC.rpt";
      CS[ReportUtils.PDFNAME] = "PENGEMBALIANKIBC_" + (string)GlobalAsp.GetSessionUser().GetValue("Userid") + "_" + DateTime.Now.ToString("yyyyMMddHHmmss") + ".pdf";
      ...
      if (n == 0)
      {
        pdfurl = ReportUtils.ExportPDF("Usadi.Valid49.Aset.Rpt.Rpt.PENGEMBALIANKIBC.rpt", CS, Params);
      }
      else
      {
        CS[ReportUtils.PDFNAME] = "PENGEMBALIANKIBC_" + (string)GlobalAsp.GetSessionUser().GetValue("Userid") + "_" + DateTime.Now.ToString("yyyyMMddHHmmss") + ".xls";
        pdfurl = ReportUtils.ExportExcel("Usadi.Valid49.Aset.Rpt.Rpt.PENGEMBALIANKIBC.rpt", CS, Params);
      }
      return pdfurl;
    }
