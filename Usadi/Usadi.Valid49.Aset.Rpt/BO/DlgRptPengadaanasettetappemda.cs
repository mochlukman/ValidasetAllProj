...
{
  #region Usadi.Valid49.BO.DlgRptPengadaanasettetappemdaasettetappemdaControl, Usadi.Valid49.Aset.Rpt
  [Serializable]
  public class DlgRptPengadaanasettetappemdaControl : DaftunitControl, IDataControlUIEntry, IPrintable
  {
    ...
    public DlgRptPengadaanasettetappemdaControl()
    {
    ...
    public string GetURLReport(int n)
    {
      ...
      CS[ReportUtils.RPTNAME] = "PENGADAAN_ASETTETAPPEMDA.rpt";
      CS[ReportUtils.PDFNAME] = "PENGADAAN_ASETTETAPPEMDA_" + (string)GlobalAsp.GetSessionUser().GetValue("Userid") + "_" + DateTime.Now.ToString("yyyyMMddHHmmss") + ".pdf";
      ...
      string pdfurl = ReportUtils.ExportPDF("Usadi.Valid49.Aset.Rpt.Rpt.PENGADAAN_ASETTETAPPEMDA.rpt", CS, Params);
      return pdfurl;
    }
  ...
  #endregion DlgRptPengadaanasettetappemda
}
