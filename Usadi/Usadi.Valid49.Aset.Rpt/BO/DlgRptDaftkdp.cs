...
{
  #region Usadi.Valid49.BO.DlgRptDaftkdpControl, Usadi.Valid49.Aset.Rpt
  [Serializable]
  public class DlgRptDaftkdpControl : DaftunitControl, IDataControlUIEntry, IPrintable
  {
    ...
    public string GetURLReport(int n)
    {
      ...
      CS[ReportUtils.RPTNAME] = "DAFTKDP.rpt";
      CS[ReportUtils.PDFNAME] = "DAFTKDP_" + (string)GlobalAsp.GetSessionUser().GetValue("Userid") + "_" + DateTime.Now.ToString("yyyyMMddHHmmss") + ".pdf";
      ...
      if(n == 0)
      {
        pdfurl = ReportUtils.ExportPDF("Usadi.Valid49.Aset.Rpt.Rpt.DAFTKDP.rpt", CS, Params);
      }
      else
      {
        CS[ReportUtils.PDFNAME] = "DAFTKDP_" + (string)GlobalAsp.GetSessionUser().GetValue("Userid") + "_" + DateTime.Now.ToString("yyyyMMddHHmmss") + ".xls";
        pdfurl = ReportUtils.ExportExcel("Usadi.Valid49.Aset.Rpt.Rpt.DAFTKDP.rpt", CS, Params);
      } 
      return pdfurl;
    }
