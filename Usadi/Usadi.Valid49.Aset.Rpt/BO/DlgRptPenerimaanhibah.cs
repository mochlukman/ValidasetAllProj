...
{
  #region Usadi.Valid49.BO.DlgRptPenerimaanhibahControl, Usadi.Valid49.Aset.Rpt
  [Serializable]
  public class DlgRptPenerimaanhibahControl : DaftunitControl, IDataControlUIEntry, IPrintable
  {
    ...
    public DlgRptPenerimaanhibahControl()
    {
    ...
    public string GetURLReport(int n)
    {
      ...
      CS[ReportUtils.RPTNAME] = $"PENERIMAAN_{StrMode}.rpt";
      CS[ReportUtils.PDFNAME] = $"PENERIMAAN_{StrMode}_{(string)GlobalAsp.GetSessionUser().GetValue("Userid")}_{ DateTime.Now.ToString("yyyyMMddHHmmss")}.pdf";
      ...
      //suffix=default,hibah,kontrak,uu,pengadilan,divestasi,inventarisasi,tukarmenukar,pembatalanpenghapusan,perolehanlainnya&
      ...
      MapMode["tukarmenukar"] = "TUKARMENUKAR";
      MapMode["pembatalanpenghapusan"] = "PEMBATALANPENGHAPUSAN";
      MapMode["perolehanlainnya"] = "PEROLEHANLAINNYA";

      string cname = "Usadi.Valid49.Aset.Rpt.Rpt.PENERIMAAN_HIBAH.rpt";
      if (!StrMode.Equals("default"))
      {
        //string strmode = StrMode.Replace(" ", "");
        string strmode = MapMode[StrMode.ToLower()];
        cname = $"Usadi.Valid49.Aset.Rpt.Rpt.PENERIMAAN_{strmode}.rpt";
      }
      ...
      {
        CS[ReportUtils.PDFNAME] = $"PENERIMAAN_{StrMode}_" + (string)GlobalAsp.GetSessionUser().GetValue("Userid") + "_" + DateTime.Now.ToString("yyyyMMddHHmmss") + ".xls";
        pdfurl = ReportUtils.ExportPDF(cname, CS, Params);
      }
      return pdfurl;
  ...
  #endregion DlgRptPenerimaanhibah
}
