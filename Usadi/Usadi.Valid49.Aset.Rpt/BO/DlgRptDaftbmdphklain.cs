...
namespace Usadi.Valid49.BO
{
  ...
  [Serializable]
  public class DlgRptDaftbmdphklainControl : DaftunitControl, IDataControlUIEntry, IPrintable
  {
    ...
    public DlgRptDaftbmdphklainControl()
    {
    ...
    public string GetURLReport(int n)
    {
      ...
      CS[ReportUtils.RPTNAME] = "DAFTBMD_PHKLAIN.rpt";
      CS[ReportUtils.PDFNAME] = "DAFTBMD_PHKLAIN_" + (string)GlobalAsp.GetSessionUser().GetValue("Userid") + "_" + DateTime.Now.ToString("yyyyMMddHHmmss") + ".pdf";
      ...
      string pdfurl = ReportUtils.ExportPDF("Usadi.Valid49.Aset.Rpt.Rpt.DAFTBMD_PHKLAIN.rpt", CS, Params);
      return pdfurl;
    }
    ...
    {
      RptPars rptPar = new RptPars() { Title = "DAFT BMD PHK LAIN", RptClass = LinkPdf };
  ...
  #endregion DlgRptDaftbmdphklain
}
