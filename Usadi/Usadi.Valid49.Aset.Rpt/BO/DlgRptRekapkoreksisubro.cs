...
{
  #region Usadi.Valid49.BO.DlgRptRekapkoreksisubroControl, Usadi.Valid49.Aset.Rpt
  [Serializable]
  public class DlgRptRekapkoreksisubroControl : DaftunitControl, IDataControlUIEntry, IPrintable
  {
    ...
    public DlgRptRekapkoreksisubroControl()
    {
    ...
    public string GetURLReport(int n)
    {
      ...
      CS[ReportUtils.RPTNAME] = "REKAPKOREKSINILAI_SUB_RO.rpt";
      CS[ReportUtils.PDFNAME] = "REKAPKOREKSINILAI_SUB_RO_" + (string)GlobalAsp.GetSessionUser().GetValue("Userid") + "_" + DateTime.Now.ToString("yyyyMMddHHmmss") + ".pdf";
      ...
      string pdfurl = ReportUtils.ExportPDF("Usadi.Valid49.Aset.Rpt.Rpt.REKAPKOREKSINILAI_SUB_RO.rpt", CS, Params);
      return pdfurl;
    }
    ...
    {
      RptPars rptPar = new RptPars() { Title = "Rekapitulasi Penjelasan Selisih Koreksi Nilai Menurut Sub-sub Rincian Objek", RptClass = LinkPdf };
