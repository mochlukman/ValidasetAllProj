...
{
  #region Usadi.Valid49.BO.DlgRptBukubrginvControl, Usadi.Valid49.Aset.Rpt
  [Serializable]
  public class DlgRptBukubrginvControl : DaftunitControl, IDataControlUIEntry, IPrintable
  {
    ...
    public DlgRptBukubrginvControl()
    {
    ...
    public string GetURLReport(int n)
    {
      ...
      CS[ReportUtils.RPTNAME] = "BukuBrgInv.rpt";
      CS[ReportUtils.PDFNAME] = "BukuBrgInv_" + (string)GlobalAsp.GetSessionUser().GetValue("Userid") + "_" + DateTime.Now.ToString("yyyyMMddHHmmss") + ".pdf";
      ...
      string pdfurl = ReportUtils.ExportPDF("Usadi.Valid49.Aset.Rpt.Rpt.BukuBrgInv.rpt", CS, Params);
      return pdfurl;
    }
    ...
    {
      RptPars rptPar = new RptPars() { Title = "BUKU BRG INV", RptClass = LinkPdf };
