...
{
  #region Usadi.Valid49.BO.DlgRptPenambahanreklasControl, Usadi.Valid49.Aset.Rpt
  [Serializable]
  public class DlgRptPenambahanreklasControl : DaftunitControl, IDataControlUIEntry, IPrintable
  {
    ...
    public DlgRptPenambahanreklasControl()
    {
    ...
    public string GetURLReport(int n)
    {
      ...
      CS[ReportUtils.RPTNAME] = "PENAMBAHAN_REKLAS.rpt";
      CS[ReportUtils.PDFNAME] = "PENAMBAHAN_REKLAS_" + (string)GlobalAsp.GetSessionUser().GetValue("Userid") + "_" + DateTime.Now.ToString("yyyyMMddHHmmss") + ".pdf";
      ...
      //string pdfurl = ReportUtils.ExportPDF("Usadi.Valid49.Aset.Rpt.Rpt.PENAMBAHAN_REKLAS.rpt", CS, Params);
      //return pdfurl;
      string pdfurl;
      if (n == 0)
      {
        pdfurl = ReportUtils.ExportPDF("Usadi.Valid49.Aset.Rpt.Rpt.PENAMBAHAN_REKLAS.rpt", CS, Params);
      }
      else
      {
        CS[ReportUtils.PDFNAME] = "PENAMBAHAN_REKLAS_" + (string)GlobalAsp.GetSessionUser().GetValue("Userid") + "_" + DateTime.Now.ToString("yyyyMMddHHmmss") + ".xls";
        pdfurl = ReportUtils.ExportExcel("Usadi.Valid49.Aset.Rpt.Rpt.PENAMBAHAN_REKLAS.rpt", CS, Params);
      }
      return pdfurl;
    }
  ...
  #endregion DlgRptPenambahanreklas
}
