...
{
  #region Usadi.Valid49.BO.DlgRptAsetlancarrbControl, Usadi.Valid49.Aset.Rpt
  [Serializable]
  public class DlgRptAsetlancarrbControl : DaftunitControl, IDataControlUIEntry, IPrintable
  {
    ...
    public DlgRptAsetlancarrbControl()
    {
    ...
    public string GetURLReport(int n)
    {
      ...
      CS[ReportUtils.RPTNAME] = "ASETLANCARRB.rpt";
      CS[ReportUtils.PDFNAME] = "ASETLANCARRB_" + (string)GlobalAsp.GetSessionUser().GetValue("Userid") + "_" + DateTime.Now.ToString("yyyyMMddHHmmss") + ".pdf";
      ...
      if (n == 0)
      {
        pdfurl = ReportUtils.ExportPDF("Usadi.Valid49.Aset.Rpt.Rpt.ASETLANCARRB.rpt", CS, Params);
      }
      else
      {
        CS[ReportUtils.PDFNAME] = "ASETLANCARRB_" + (string)GlobalAsp.GetSessionUser().GetValue("Userid") + "_" + DateTime.Now.ToString("yyyyMMddHHmmss") + ".xls";
        pdfurl = ReportUtils.ExportExcel("Usadi.Valid49.Aset.Rpt.Rpt.ASETLANCARRB.rpt", CS, Params);
      }
      return pdfurl;
    }
