...
{
  #region Usadi.Valid49.BO.DlgRptPengakhiranpemanfaatanControl, Usadi.Valid49.Aset.Rpt
  [Serializable]
  public class DlgRptPengakhiranpemanfaatanControl : DaftunitControl, IDataControlUIEntry, IPrintable
  {
    ...
    public DlgRptPengakhiranpemanfaatanControl()
    {
    ...
    public string GetURLReport(int n)
    {
      ...
      CS[ReportUtils.RPTNAME] = "PENGAKHIRANPEMANFAATAN.rpt";
      CS[ReportUtils.PDFNAME] = "PENGAKHIRANPEMANFAATAN_" + (string)GlobalAsp.GetSessionUser().GetValue("Userid") + "_" + DateTime.Now.ToString("yyyyMMddHHmmss") + ".pdf";
      ...
      string pdfurl = ReportUtils.ExportPDF("Usadi.Valid49.Aset.Rpt.Rpt.PENGAKHIRANPEMANFAATAN.rpt", CS, Params);
      return pdfurl;
    }
    ...
    {
      RptPars rptPar = new RptPars() { Title = "Laporan Pengakhiran Pemanfaatan BMD", RptClass = LinkPdf };
  ...
  #endregion DlgRptPengakhiranpemanfaatan
}
