...
{
  #region Usadi.Valid49.BO.DlgRptDaftkdpreklasControl, Usadi.Valid49.Aset.Rpt
  [Serializable]
  public class DlgRptDaftkdpreklasControl : DaftunitControl, IDataControlUIEntry, IPrintable
  {
    ...
    public DlgRptDaftkdpreklasControl()
    {
    ...
    public string GetURLReport(int n)
    {
      ...
      CS[ReportUtils.RPTNAME] = "DAFTKDP_REKLAS.rpt";
      CS[ReportUtils.PDFNAME] = "DAFTKDP_REKLAS_" + (string)GlobalAsp.GetSessionUser().GetValue("Userid") + "_" + DateTime.Now.ToString("yyyyMMddHHmmss") + ".pdf";
      ...
      if(n == 0)
      {
        pdfurl = ReportUtils.ExportPDF("Usadi.Valid49.Aset.Rpt.Rpt.DAFTKDP_REKLAS.rpt", CS, Params);
      }
      else
      {
        CS[ReportUtils.PDFNAME] = "DAFTKDP_REKLAS_" + (string)GlobalAsp.GetSessionUser().GetValue("Userid") + "_" + DateTime.Now.ToString("yyyyMMddHHmmss") + ".xls";
        pdfurl = ReportUtils.ExportExcel("Usadi.Valid49.Aset.Rpt.Rpt.DAFTKDP_REKLAS.rpt", CS, Params);
      }
      return pdfurl;
    }
