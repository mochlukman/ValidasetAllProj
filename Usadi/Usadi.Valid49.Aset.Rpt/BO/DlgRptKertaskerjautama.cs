...
{
  #region Usadi.Valid49.BO.DlgRptKertaskerjautamaControl, Usadi.Valid49.Aset.Rpt
  [Serializable]
  public class DlgRptKertaskerjautamaControl : DaftunitControl, IDataControlUIEntry, IPrintable
  {
    ...
    public DlgRptKertaskerjautamaControl()
    {
    ...
    public string GetURLReport(int n)
    {
      ...
      CS[ReportUtils.RPTNAME] = "KertasKerjaUtama.rpt";
      CS[ReportUtils.PDFNAME] = "KertasKerjaUtama_" + (string)GlobalAsp.GetSessionUser().GetValue("Userid") + "_" + DateTime.Now.ToString("yyyyMMddHHmmss") + ".pdf";
      ...
      if(n == 0)
      {
        pdfurl = ReportUtils.ExportPDF("Usadi.Valid49.Aset.Rpt.Rpt.KertasKerjaUtama.rpt", CS, Params);
      }
      else
      {
        CS[ReportUtils.PDFNAME] = "KertasKerjaUtama_" + (string)GlobalAsp.GetSessionUser().GetValue("Userid") + "_" + DateTime.Now.ToString("yyyyMMddHHmmss") + ".xls";
        pdfurl = ReportUtils.ExportExcel("Usadi.Valid49.Aset.Rpt.Rpt.KertasKerjaUtama.rpt", CS, Params);
      } 
      return pdfurl;
    }
  ...
  #endregion DlgRptKertaskerjautama
}
