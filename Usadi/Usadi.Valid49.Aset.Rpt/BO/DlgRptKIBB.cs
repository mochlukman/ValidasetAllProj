...
{
  #region Usadi.Valid49.BO.DlgRptKIBBControl, Usadi.Valid49.Aset.Rpt
  [Serializable]
  public class DlgRptKIBBControl : DaftunitControl, IDataControlUIEntry, IPrintable
  {
    ...
    public string GetURLReport(int n)
    {
      ...
      CS[ReportUtils.RPTNAME] = "KIB_B.rpt";
      CS[ReportUtils.PDFNAME] = "KIBB_" + (string)GlobalAsp.GetSessionUser().GetValue("Userid") + "_" + DateTime.Now.ToString("yyyyMMddHHmmss") + ".pdf";
      ...
      if(n == 0)
      {
        pdfurl = ReportUtils.ExportPDF("Usadi.Valid49.Aset.Rpt.Rpt.KIB_B.rpt", CS, Params);
      }
      else
      {
        CS[ReportUtils.PDFNAME] = "KIBB_" + (string)GlobalAsp.GetSessionUser().GetValue("Userid") + "_" + DateTime.Now.ToString("yyyyMMddHHmmss") + ".xls";
        pdfurl = ReportUtils.ExportExcel("Usadi.Valid49.Aset.Rpt.Rpt.KIB_B.rpt", CS, Params);
      } 
      return pdfurl;
    }
