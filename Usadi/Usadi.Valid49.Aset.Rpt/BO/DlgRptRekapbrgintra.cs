...
{
  #region Usadi.Valid49.BO.DlgRptRekapbrgintraControl, Usadi.Valid49.Aset.Rpt
  [Serializable]
  public class DlgRptRekapbrgintraControl : DaftunitControl, IDataControlUIEntry, IPrintable
  {
    ...
    public DlgRptRekapbrgintraControl()
    {
    ...
    public string GetURLReport(int n)
    {
      ...
      CS[ReportUtils.RPTNAME] = "REKAPBRG_INTRA.rpt";
      CS[ReportUtils.PDFNAME] = "REKAPBRG_INTRA_" + (string)GlobalAsp.GetSessionUser().GetValue("Userid") + "_" + DateTime.Now.ToString("yyyyMMddHHmmss") + ".pdf";
      ...
      if(n == 0)
      {
        pdfurl = ReportUtils.ExportPDF("Usadi.Valid49.Aset.Rpt.Rpt.REKAPBRG_INTRA.rpt", CS, Params);
      }
      else
      {
        CS[ReportUtils.PDFNAME] = "REKAPBRG_INTRA_" + (string)GlobalAsp.GetSessionUser().GetValue("Userid") + "_" + DateTime.Now.ToString("yyyyMMddHHmmss") + ".xls";
        pdfurl = ReportUtils.ExportExcel("Usadi.Valid49.Aset.Rpt.Rpt.REKAPBRG_INTRA.rpt", CS, Params);
      }
      return pdfurl;
    }
    ...
    public List<RptPars> GetReports()
    {
      ...
      RptPars rptPar1 = new RptPars() { Title = "Excel", RptClass = LinkPdf };
