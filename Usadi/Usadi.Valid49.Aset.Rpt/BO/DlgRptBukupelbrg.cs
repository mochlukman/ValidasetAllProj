...
{
  #region Usadi.Valid49.BO.DlgRptBukupelbrgControl, Usadi.Valid49.Aset.Rpt
  [Serializable]
  public class DlgRptBukupelbrgControl : DaftunitControl, IDataControlUIEntry, IPrintable
  {
    ...
    public DlgRptBukupelbrgControl()
    {
    ...
    public string GetURLReport(int n)
    {
      ...
      CS[ReportUtils.RPTNAME] = "BUKUPELBRG.rpt";
      CS[ReportUtils.PDFNAME] = "BUKUPELBRG_" + (string)GlobalAsp.GetSessionUser().GetValue("Userid") + "_" + DateTime.Now.ToString("yyyyMMddHHmmss") + ".pdf";
      ...
      string pdfurl = ReportUtils.ExportPDF("Usadi.Valid49.Aset.Rpt.Rpt.BUKUPELBRG.rpt", CS, Params);
      return pdfurl;
    }
    ...
    {
      RptPars rptPar = new RptPars() { Title = "DAFT PEMELIHARAAN", RptClass = LinkPdf };
