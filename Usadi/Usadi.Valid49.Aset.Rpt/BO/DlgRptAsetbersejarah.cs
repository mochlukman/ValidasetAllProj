...
{
  #region Usadi.Valid49.BO.DlgRptAsetbersejarahControl, Usadi.Valid49.Aset.Rpt
  [Serializable]
  public class DlgRptAsetbersejarahControl : DaftunitControl, IDataControlUIEntry, IPrintable
  {
    ...
    public DlgRptAsetbersejarahControl()
    {
    ...
    public string GetURLReport(int n)
    {
      ...
      CS[ReportUtils.RPTNAME] = "ASETSEJARAH.rpt";
      CS[ReportUtils.PDFNAME] = "ASETSEJARAH_" + (string)GlobalAsp.GetSessionUser().GetValue("Userid") + "_" + DateTime.Now.ToString("yyyyMMddHHmmss") + ".pdf";
      ...
      if(n == 0)
      {
        pdfurl = ReportUtils.ExportPDF("Usadi.Valid49.Aset.Rpt.Rpt.ASETSEJARAH.rpt", CS, Params);
      }
      else
      {
        CS[ReportUtils.PDFNAME] = "ASETSEJARAH_" + (string)GlobalAsp.GetSessionUser().GetValue("Userid") + "_" + DateTime.Now.ToString("yyyyMMddHHmmss") + ".xls";
        pdfurl = ReportUtils.ExportExcel("Usadi.Valid49.Aset.Rpt.Rpt.ASETSEJARAH.rpt", CS, Params);
      } 
      return pdfurl;
    }
