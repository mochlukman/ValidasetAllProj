...
{
  #region Usadi.Valid49.BO.DlgRptLapmutasibrgControl, Usadi.Valid49.Aset.Rpt
  [Serializable]
  public class DlgRptLapmutasibrgControl : DaftunitControl, IDataControlUIEntry, IPrintable
  {
    ...
    public DlgRptLapmutasibrgControl()
    {
    ...
    public string GetURLReport(int n)
    {
      ...
      CS[ReportUtils.RPTNAME] = "LapMutasiBrg.rpt";
      CS[ReportUtils.PDFNAME] = "LapMutasiBrg_" + (string)GlobalAsp.GetSessionUser().GetValue("Userid") + "_" + DateTime.Now.ToString("yyyyMMddHHmmss") + ".pdf";
      ...
      if(n == 0)
      {
        pdfurl = ReportUtils.ExportPDF("Usadi.Valid49.Aset.Rpt.Rpt.LapMutasiBrg.rpt", CS, Params);
      }
      else
      {
        CS[ReportUtils.PDFNAME] = "LapMutasiBrg_" + (string)GlobalAsp.GetSessionUser().GetValue("Userid") + "_" + DateTime.Now.ToString("yyyyMMddHHmmss") + ".xls";
        pdfurl = ReportUtils.ExportExcel("Usadi.Valid49.Aset.Rpt.Rpt.LapMutasiBrg.rpt", CS, Params);
      } 
      return pdfurl;
    }
