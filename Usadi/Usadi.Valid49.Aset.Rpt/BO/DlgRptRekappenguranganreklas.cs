...
{
  #region Usadi.Valid49.BO.DlgRptRekappenguranganreklasControl, Usadi.Valid49.Aset.Rpt
  [Serializable]
  public class DlgRptRekappenguranganreklasControl : DaftunitControl, IDataControlUIEntry, IPrintable
  {
    ...
    public DlgRptRekappenguranganreklasControl()
    {
    ...
    public string GetURLReport(int n)
    {
      ...
      CS[ReportUtils.RPTNAME] = "REKAPPENGURANGAN_REKLAS.rpt";
      CS[ReportUtils.PDFNAME] = "REKAPPENGURANGAN_REKLAS_" + (string)GlobalAsp.GetSessionUser().GetValue("Userid") + "_" + DateTime.Now.ToString("yyyyMMddHHmmss") + ".pdf";
      ...
      string pdfurl = ReportUtils.ExportPDF("Usadi.Valid49.Aset.Rpt.Rpt.REKAPPENGURANGAN_REKLAS.rpt", CS, Params);
      return pdfurl;
    }
    ...
    {
      RptPars rptPar = new RptPars() { Title = "Rekapitulasi Pengurangan Reklasifikasi BMD", RptClass = LinkPdf };
  ...
  #endregion DlgRptDlgRptRekappenguranganreklas
}
