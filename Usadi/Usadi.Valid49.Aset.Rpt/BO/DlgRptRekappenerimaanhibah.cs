...
{
  #region Usadi.Valid49.BO.DlgRptRekappenerimaanhibahControl, Usadi.Valid49.Aset.Rpt
  [Serializable]
  public class DlgRptRekappenerimaanhibahControl : DaftunitControl, IDataControlUIEntry, IPrintable
  {
    ...
    public DlgRptRekappenerimaanhibahControl()
    {
    ...
    public override HashTableofParameterRow GetEntries()
    {
      ...
      hpars.Add(new ParameterRow(ConstantDict.GetColumnTitleEntry("StrMode=Penerimaan"), ParameterRow.MODE_SELECT,
    ...
    public string GetURLReport(int n)
    {
      ...
      CS[ReportUtils.RPTNAME] = $"REKAPPENERIMAAN_{StrMode}.rpt";
      CS[ReportUtils.PDFNAME] = $"REKAPPENERIMAAN_{(string)GlobalAsp.GetSessionUser().GetValue("Userid")}_{ DateTime.Now.ToString("yyyyMMddHHmmss")}.pdf";
      ...
      //lokasi rpt
      //string lokasirpt = @"E:\Projc\ASET_NEW\ModulAset\Usadi\Usadi.Valid49.Aset.Rpt\Rpt\REKAPPENERIMAAN_HIBAH.rpt";
      //if (!StrMode.Equals("default"))
      //{
      //  lokasirpt = $@"E:\Projc\ASET_NEW\ModulAset\Usadi\Usadi.Valid49.Aset.Rpt\Rpt\REKAPPENERIMAAN_{StrMode}.rpt";
      //}
      ...
      MapMode["hibah"] = "HIBAH";
      MapMode["kontrak"] = "KONTRAK";
      MapMode["uu"] = "UU";
      MapMode["pengadilan"] = "PENGADILAN";
      MapMode["divestasi"] = "DIVESTASI";
      MapMode["inventarisasi"] = "INVENTARISASI";
      MapMode["tukar menukar"] = "TUKARMENUKAR";
      MapMode["pembatalan penghapusan"] = "PEMBATALANPENGHAPUSAN";
      MapMode["perolehan lainnya"] = "PEROLEHANLAINNYA";

      string cname = "Usadi.Valid49.Aset.Rpt.Rpt.REKAPPENERIMAAN_HIBAH.rpt";
      if (!StrMode.Equals("default"))
      {
        //string strmode = StrMode.Replace(" ", "");
        string strmode = MapMode[StrMode.ToLower()];
        cname = $"Usadi.Valid49.Aset.Rpt.Rpt.REKAPPENERIMAAN_{strmode}.rpt";
      }
    ...
    {
      RptPars rptPar = new RptPars() { Title = "Rekapitulasi Penerimaan BMD dari Perolehan Lainnya", RptClass = LinkPdf };
  ...
  #endregion DlgRptRekappenerimaanhibah
}
