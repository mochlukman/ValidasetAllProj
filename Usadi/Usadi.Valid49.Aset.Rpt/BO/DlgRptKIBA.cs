...
{
  #region Usadi.Valid49.BO.DlgRptKIBAControl, Usadi.Valid49.Aset.Rpt
  [Serializable]
  public class DlgRptKIBAControl : DaftunitControl, IDataControlUIEntry, IPrintable
  {
    ...
    public string GetURLReport(int n)
    {
      ...
      CS[ReportUtils.RPTNAME] = "KIB_A.rpt";
      CS[ReportUtils.PDFNAME] = "KIBA_" + (string)GlobalAsp.GetSessionUser().GetValue("Userid") + "_" + DateTime.Now.ToString("yyyyMMddHHmmss") + ".pdf";
      ...
      if(n == 0)
      {
        pdfurl = ReportUtils.ExportPDF("Usadi.Valid49.Aset.Rpt.Rpt.KIB_A.rpt", CS, Params);
      }
      else
      {
        CS[ReportUtils.PDFNAME] = "KIBA_" + (string)GlobalAsp.GetSessionUser().GetValue("Userid") + "_" + DateTime.Now.ToString("yyyyMMddHHmmss") + ".xls";
        pdfurl = ReportUtils.ExportExcel("Usadi.Valid49.Aset.Rpt.Rpt.KIB_A.rpt", CS, Params);
      } 
      return pdfurl;
    }
