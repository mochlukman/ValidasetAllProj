...
{
  #region Usadi.Valid49.BO.DlgRptRincutangControl, Usadi.Valid49.Aset.Rpt
  [Serializable]
  public class DlgRptRincutangControl : DaftunitControl, IDataControlUIEntry, IPrintable
  {
    ...
    public string GetURLReport(int n)
    {
      ...
      CS[ReportUtils.RPTNAME] = "RINCUTANG.rpt";
      CS[ReportUtils.PDFNAME] = "RINCUTANG_" + (string)GlobalAsp.GetSessionUser().GetValue("Userid") + "_" + DateTime.Now.ToString("yyyyMMddHHmmss") + ".pdf";
      ...
      string pdfurl = ReportUtils.ExportPDF("Usadi.Valid49.Aset.Rpt.Rpt.RINCUTANG.rpt", CS, Params);
      return pdfurl;
    }
    ...
    {
      RptPars rptPar = new RptPars() { Title = "RINCIAN UTANG", RptClass = LinkPdf };
