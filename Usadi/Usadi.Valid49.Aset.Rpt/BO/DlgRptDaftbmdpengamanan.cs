...
{
  #region Usadi.Valid49.BO.DlgRptDaftbmdpengamananControl, Usadi.Valid49.Aset.Rpt
  [Serializable]
  public class DlgRptDaftbmdpengamananControl : DaftunitControl, IDataControlUIEntry, IPrintable
  {
    ...
    public DlgRptDaftbmdpengamananControl()
    {
    ...
    public string GetURLReport(int n)
    {
      ...
      CS[ReportUtils.RPTNAME] = "DAFTBMD_PENGAMANAN.rpt";
      CS[ReportUtils.PDFNAME] = "DAFTBMD_PENGAMANAN_" + (string)GlobalAsp.GetSessionUser().GetValue("Userid") + "_" + DateTime.Now.ToString("yyyyMMddHHmmss") + ".pdf";
      ...
      string pdfurl = ReportUtils.ExportPDF("Usadi.Valid49.Aset.Rpt.Rpt.DAFTBMD_PENGAMANAN.rpt", CS, Params);
      return pdfurl;
    }
    ...
    {
      RptPars rptPar = new RptPars() { Title = "DAFT BMD", RptClass = LinkPdf };
  ...
  #endregion DlgRptDaftbmdpengamanan
}
