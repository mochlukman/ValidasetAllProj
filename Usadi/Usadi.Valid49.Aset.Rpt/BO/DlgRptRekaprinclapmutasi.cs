...
{
  #region Usadi.Valid49.BO.DlgRptRekaprinclapmutasiControl, Usadi.Valid49.Aset.Rpt
  [Serializable]
  public class DlgRptRekaprinclapmutasiControl : DaftunitControl, IDataControlUIEntry, IPrintable
  {
    ...
    public DlgRptRekaprinclapmutasiControl()
    {
    ...
    public string GetURLReport(int n)
    {
      ...
      CS[ReportUtils.RPTNAME] = "REKAPRINCLAPMUTASI.rpt";
      CS[ReportUtils.PDFNAME] = "REKAPRINCLAPMUTASI_" + (string)GlobalAsp.GetSessionUser().GetValue("Userid") + "_" + DateTime.Now.ToString("yyyyMMddHHmmss") + ".pdf";
      ...
      if(n == 0)
      {
        pdfurl = ReportUtils.ExportPDF("Usadi.Valid49.Aset.Rpt.Rpt.REKAPRINCLAPMUTASI.rpt", CS, Params);
      }
      else
      {
        CS[ReportUtils.PDFNAME] = "REKAPRINCLAPMUTASI_" + (string)GlobalAsp.GetSessionUser().GetValue("Userid") + "_" + DateTime.Now.ToString("yyyyMMddHHmmss") + ".xls";
  ...
  #endregion DlgRptRekaprinclapmutasi
}
