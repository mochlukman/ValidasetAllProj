...
{
  #region Usadi.Valid49.BO.DlgRptKIBDControl, Usadi.Valid49.Aset.Rpt
  [Serializable]
  public class DlgRptKIBDControl : DaftunitControl, IDataControlUIEntry, IPrintable
  {
    ...
    public string GetURLReport(int n)
    {
      ...
      CS[ReportUtils.RPTNAME] = "KIB_D.rpt";
      CS[ReportUtils.PDFNAME] = "KIBD_" + (string)GlobalAsp.GetSessionUser().GetValue("Userid") + "_" + DateTime.Now.ToString("yyyyMMddHHmmss") + ".pdf";
      ...
      if(n == 0)
      {
        pdfurl = ReportUtils.ExportPDF("Usadi.Valid49.Aset.Rpt.Rpt.KIB_D.rpt", CS, Params);
      }
      else
      {
        CS[ReportUtils.PDFNAME] = "KIBD_" + (string)GlobalAsp.GetSessionUser().GetValue("Userid") + "_" + DateTime.Now.ToString("yyyyMMddHHmmss") + ".xls";
        pdfurl = ReportUtils.ExportExcel("Usadi.Valid49.Aset.Rpt.Rpt.KIB_D.rpt", CS, Params);
      } 
      return pdfurl;
    }
