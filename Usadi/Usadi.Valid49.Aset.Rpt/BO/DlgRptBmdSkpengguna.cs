...
{
  #region Usadi.Valid49.BO.DlgRptBmdSkpenggunaControl, Usadi.Valid49.Aset.Rpt
  [Serializable]
  public class DlgRptBmdSkpenggunaControl : DaftunitControl, IDataControlUIEntry, IPrintable
  {
    ...
    public string Tglskpengguna { get; set; }
    ...
    public DlgRptBmdSkpenggunaControl()
    {
    ...
    public override HashTableofParameterRow GetEntries()
    {
      ...
      //      GetList(new TahunSusutLookupControl()), "Kdtahun=Nmtahun", 26).SetAllowRefresh(true).SetEnable(enableFilter).SetAllowEmpty(false));
      hpars.Add(SkpenggunaLookupControl.Instance.GetLookupParameterRow(this, false));
    ...
    public string GetURLReport(int n)
    {
      ...
      CS[ReportUtils.RPTNAME] = "PENETAPAN_PENGGUNA.rpt";
      CS[ReportUtils.PDFNAME] = "PENETAPAN_PENGGUNA_" + (string)GlobalAsp.GetSessionUser().GetValue("Userid") + "_" + DateTime.Now.ToString("yyyyMMddHHmmss") + ".pdf";


      Hashtable Params = new Hashtable();
      Params["@unitkey"] = Unitkey;
      Params["@Noskpengguna"] = Nodokumen;
      ...
      if (n == 0)
      {
        pdfurl = ReportUtils.ExportPDF("Usadi.Valid49.Aset.Rpt.Rpt.PENETAPAN_PENGGUNA.rpt", CS, Params);
      }
      else
      {
        CS[ReportUtils.PDFNAME] = "PENETAPAN_PENGGUNA_" + (string)GlobalAsp.GetSessionUser().GetValue("Userid") + "_" + DateTime.Now.ToString("yyyyMMddHHmmss") + ".xls";
        pdfurl = ReportUtils.ExportExcel("Usadi.Valid49.Aset.Rpt.Rpt.PENETAPAN_PENGGUNA.rpt", CS, Params);
      }
      return pdfurl;
    }
