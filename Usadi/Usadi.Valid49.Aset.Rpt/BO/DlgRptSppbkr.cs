...
{
  #region Usadi.Valid49.BO.DlgRptSppbkrControl, Usadi.Valid49.Aset.Rpt
  [Serializable]
  public class DlgRptSppbkrControl : DaftunitControl, IDataControlUIEntry, IPrintable
  {
    ...
    public override HashTableofParameterRow GetEntries()
    {
      ...
      hpars.Add(SpbLookupControl.Instance.GetLookupParameterRow(this, false).SetEnable(enableFilter));
    ...
    public string GetURLReport(int n)
    {
      ...
      CS[ReportUtils.RPTNAME] = "SPPBKR.rpt";
      CS[ReportUtils.PDFNAME] = "SPPBKR_" + (string)GlobalAsp.GetSessionUser().GetValue("Userid") + "_" + DateTime.Now.ToString("yyyyMMddHHmmss") + ".pdf";
      ...
      if(n == 0)
      {
        pdfurl = ReportUtils.ExportPDF("Usadi.Valid49.Aset.Rpt.Rpt.SPPBKR.rpt", CS, Params);
      }
      else
      {
        CS[ReportUtils.PDFNAME] = "SPPBKR_" + (string)GlobalAsp.GetSessionUser().GetValue("Userid") + "_" + DateTime.Now.ToString("yyyyMMddHHmmss") + ".xls";
        pdfurl = ReportUtils.ExportExcel("Usadi.Valid49.Aset.Rpt.Rpt.SPPBKR.rpt", CS, Params);
      } 
      return pdfurl;
    }
