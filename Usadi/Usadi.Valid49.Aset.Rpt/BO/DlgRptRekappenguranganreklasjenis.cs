...
{
  #region Usadi.Valid49.BO.DlgRptRekappenguranganreklasjenisControl, Usadi.Valid49.Aset.Rpt
  [Serializable]
  public class DlgRptRekappenguranganreklasjenisControl : DaftunitControl, IDataControlUIEntry, IPrintable
  {
    ...
    public DlgRptRekappenguranganreklasjenisControl()
    {
    ...
    public string GetURLReport(int n)
    {
      ...
      CS[ReportUtils.RPTNAME] = "REKAPPENGURANGAN_REKLAS_JENIS.rpt";
      CS[ReportUtils.PDFNAME] = "REKAPPENGURANGAN_REKLAS_JENIS_" + (string)GlobalAsp.GetSessionUser().GetValue("Userid") + "_" + DateTime.Now.ToString("yyyyMMddHHmmss") + ".pdf";
      ...
      string pdfurl = ReportUtils.ExportPDF("Usadi.Valid49.Aset.Rpt.Rpt.REKAPPENGURANGAN_REKLAS_JENIS.rpt", CS, Params);
      return pdfurl;
    }
    ...
    {
      RptPars rptPar = new RptPars() { Title = "Rekapitulasi Pengurangan Reklasifikasi BMD Menurut Jenis", RptClass = LinkPdf };
  ...
  #endregion DlgRptDlgRptRekappenguranganreklasjenis
}
