...
{
  #region Usadi.Valid49.BO.DlgRptRekappenerimaaninternalControl, Usadi.Valid49.Aset.Rpt
  [Serializable]
  public class DlgRptRekappenerimaaninternalControl : DaftunitControl, IDataControlUIEntry, IPrintable
  {
    ...
    public DlgRptRekappenerimaaninternalControl()
    {
    ...
    public string GetURLReport(int n)
    {
      ...
      CS[ReportUtils.RPTNAME] = "REKAPPENERIMAAN_INTERNAL.rpt";
      CS[ReportUtils.PDFNAME] = "REKAPPENERIMAAN_INTERNAL_" + (string)GlobalAsp.GetSessionUser().GetValue("Userid") + "_" + DateTime.Now.ToString("yyyyMMddHHmmss") + ".pdf";
      ...
      string pdfurl = ReportUtils.ExportPDF("Usadi.Valid49.Aset.Rpt.Rpt.REKAPPENERIMAAN_INTERNAL.rpt", CS, Params);
      return pdfurl;
    }
    ...
    {
      RptPars rptPar = new RptPars() { Title = "Rekapitulasi Penerimaan BMD Internal", RptClass = LinkPdf };
  ...
  #endregion DlgRptRekappenerimaaninternal
}
