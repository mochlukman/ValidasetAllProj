...
{
  #region Usadi.Valid49.BO.DlgRptRekappenggunaanpspControl, Usadi.Valid49.Aset.Rpt
  [Serializable]
  public class DlgRptRekappenggunaanpspControl : DaftunitControl, IDataControlUIEntry, IPrintable
  {
    ...
    public DlgRptRekappenggunaanpspControl()
    {
    ...
    public string GetURLReport(int n)
    {
      ...
      CS[ReportUtils.RPTNAME] = "REKAPPENGGUNAAN_PSP.rpt";
      CS[ReportUtils.PDFNAME] = "REKAPPENGGUNAAN_PSP_" + (string)GlobalAsp.GetSessionUser().GetValue("Userid") + "_" + DateTime.Now.ToString("yyyyMMddHHmmss") + ".pdf";
      ...
      string pdfurl = ReportUtils.ExportPDF("Usadi.Valid49.Aset.Rpt.Rpt.REKAPPENGGUNAAN_PSP.rpt", CS, Params);
      return pdfurl;
    }
    ...
    {
      RptPars rptPar = new RptPars() { Title = "Rekapitulasi Penerimaan Penggunaan", RptClass = LinkPdf };
  ...
  #endregion DlgRptRekappenggunaanpsp
}
