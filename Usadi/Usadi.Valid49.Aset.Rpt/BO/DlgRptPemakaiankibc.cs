...
{
  #region Usadi.Valid49.BO.DlgRptPemakaiankibcControl, Usadi.Valid49.Aset.Rpt
  [Serializable]
  public class DlgRptPemakaiankibcControl : DaftunitControl, IDataControlUIEntry, IPrintable
  {
    ...
    public DlgRptPemakaiankibcControl()
    {
    ...
    public string GetURLReport(int n)
    {
      ...
      CS[ReportUtils.RPTNAME] = "PEMAKAIANKIBC.rpt";
      CS[ReportUtils.PDFNAME] = "PEMAKAIANKIBC_" + (string)GlobalAsp.GetSessionUser().GetValue("Userid") + "_" + DateTime.Now.ToString("yyyyMMddHHmmss") + ".pdf";
      ...
      if (n == 0)
      {
        pdfurl = ReportUtils.ExportPDF("Usadi.Valid49.Aset.Rpt.Rpt.PEMAKAIANKIBC.rpt", CS, Params);
      }
      else
      {
        CS[ReportUtils.PDFNAME] = "PEMAKAIANKIBC_" + (string)GlobalAsp.GetSessionUser().GetValue("Userid") + "_" + DateTime.Now.ToString("yyyyMMddHHmmss") + ".xls";
        pdfurl = ReportUtils.ExportExcel("Usadi.Valid49.Aset.Rpt.Rpt.PEMAKAIANKIBC.rpt", CS, Params);
      }
      return pdfurl;
    }
