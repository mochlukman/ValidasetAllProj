...
{
  #region Usadi.Valid49.BO.DlgRptDaftmutasibrgControl, Usadi.Valid49.Aset.Rpt
  [Serializable]
  public class DlgRptDaftmutasibrgControl : DaftunitControl, IDataControlUIEntry, IPrintable
  {
    ...
    public DlgRptDaftmutasibrgControl()
    {
    ...
    public string GetURLReport(int n)
    {
      ...
      CS[ReportUtils.RPTNAME] = "DaftMutasiBrg.rpt";
      CS[ReportUtils.PDFNAME] = "DaftMutasiBrg_" + (string)GlobalAsp.GetSessionUser().GetValue("Userid") + "_" + DateTime.Now.ToString("yyyyMMddHHmmss") + ".pdf";
      ...
      string pdfurl = ReportUtils.ExportPDF("Usadi.Valid49.Aset.Rpt.Rpt.DaftMutasiBrg.rpt", CS, Params);
      return pdfurl;
    }
    ...
    {
      RptPars rptPar = new RptPars() { Title = "DAFT MUTASI BRG", RptClass = LinkPdf };
