...
{
  #region Usadi.Valid49.BO.DlgRptRekapbrgekstraControl, Usadi.Valid49.Aset.Rpt
  [Serializable]
  public class DlgRptRekapbrgekstraControl : DaftunitControl, IDataControlUIEntry, IPrintable
  {
    ...
    public DlgRptRekapbrgekstraControl()
    {
    ...
    public string GetURLReport(int n)
    {
      ...
      CS[ReportUtils.RPTNAME] = "REKAPBRG_EKSTRA.rpt";
      CS[ReportUtils.PDFNAME] = "REKAPBRG_EKSTRA_" + (string)GlobalAsp.GetSessionUser().GetValue("Userid") + "_" + DateTime.Now.ToString("yyyyMMddHHmmss") + ".pdf";
      ...
      if(n == 0)
      {
        pdfurl = ReportUtils.ExportPDF("Usadi.Valid49.Aset.Rpt.Rpt.REKAPBRG_EKSTRA.rpt", CS, Params);
      }
      else
      {
        CS[ReportUtils.PDFNAME] = "REKAPBRG_EKSTRA_" + (string)GlobalAsp.GetSessionUser().GetValue("Userid") + "_" + DateTime.Now.ToString("yyyyMMddHHmmss") + ".xls";
        pdfurl = ReportUtils.ExportExcel("Usadi.Valid49.Aset.Rpt.Rpt.REKAPBRG_EKSTRA.rpt", CS, Params);
      } 
      return pdfurl;
    }
  ...
  #endregion DlgRptRekapbrgekstra
}
