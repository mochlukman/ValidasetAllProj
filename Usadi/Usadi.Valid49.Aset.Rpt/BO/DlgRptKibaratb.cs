...
{
  #region Usadi.Valid49.BO.DlgRptKibaratbControl, Usadi.Valid49.Aset.Rpt
  [Serializable]
  public class DlgRptKibaratbControl : KibgControl, IDataControlUIEntry, IPrintable
  {
    ...
    public string GetURLReport(int n)
    {
      ...
      CS[ReportUtils.RPTNAME] = "KIBARATB.rpt";
      CS[ReportUtils.PDFNAME] = "KIBARATB_" + (string)GlobalAsp.GetSessionUser().GetValue("Userid") + "_" + DateTime.Now.ToString("yyyyMMddHHmmss") + ".pdf";
      ...
      if (n == 0)
      {
        pdfurl = ReportUtils.ExportPDF("Usadi.Valid49.Aset.Rpt.Rpt.KIBARATB.rpt", CS, Params);
      }
      else
      {
        CS[ReportUtils.PDFNAME] = "KIBARATB_" + (string)GlobalAsp.GetSessionUser().GetValue("Userid") + "_" + DateTime.Now.ToString("yyyyMMddHHmmss") + ".xls";
        pdfurl = ReportUtils.ExportExcel("Usadi.Valid49.Aset.Rpt.Rpt.KIBARATB.rpt", CS, Params);
      }
      return pdfurl;
    }
