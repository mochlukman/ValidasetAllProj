...
{
  #region Usadi.Valid49.BO.DlgRptRKBMDPengadaanControl, Usadi.Valid49.Aset.Rpt
  [Serializable]
  public class DlgRptRKBMDPengadaanControl : DaftunitControl, IDataControlUIEntry, IPrintable
  {
    ...
    public DlgRptRKBMDPengadaanControl()
    {
    ...
    public override HashTableofParameterRow GetEntries()
    {
      ...
      //hpars.Add(new ParameterRow(ConstantDict.GetColumnTitleEntry("StrMode=Mode"), ParameterRow.MODE_SELECT,
      //  Options, "Kdpar=Nmpar", 26).SetEnable(enableFilter));
      return hpars;
    }
    ...
    public string GetURLReport(int n)
    {
      ...
      CS[ReportUtils.RPTNAME] = $"RKBMD_Pengadaan.rpt";
      CS[ReportUtils.PDFNAME] = $"RKBMD_Pengadaan_{(string)GlobalAsp.GetSessionUser().GetValue("Userid")}_{ DateTime.Now.ToString("yyyyMMddHHmmss")}.pdf";
      ...
      //string lokasirpt = @"E:\Projc\ASET_NEW\ModulAset\Usadi\Usadi.Valid49.Aset.Rpt\Rpt\RKBMD_Pengadaan.rpt";
      //if (!StrMode.Equals("default"))
      //{
      //  lokasirpt = $@"E:\Projc\ASET_NEW\ModulAset\Usadi\Usadi.Valid49.Aset.Rpt\Rpt\RKBMD_Pengadaan_{StrMode}.rpt";
      //}
      //string pdfurl = ReportUtils.ExportPDF(lokasirpt, CS, Params);

      //string cname = "Usadi.Valid49.Aset.Rpt.Rpt.RKBMD_Pengadaan.rpt";
      //if (!StrMode.Equals("default"))
      //{
      //  cname = $"Usadi.Valid49.Aset.Rpt.Rpt.RKBMD_Pengadaan_{StrMode}.rpt";
      //}
      //string pdfurl = ReportUtils.ExportPDF(cname, CS, Params);
      string pdfurl = ReportUtils.ExportPDF("Usadi.Valid49.Aset.Rpt.Rpt.RKBMD_Pengadaan.rpt", CS, Params);
      return pdfurl;
    }
    ...
    {
      RptPars rptPar = new RptPars() { Title = "RKBMD Pengadaan", RptClass = LinkPdf };
  ...
  #endregion DlgRptRKBMDPengadaan
}
