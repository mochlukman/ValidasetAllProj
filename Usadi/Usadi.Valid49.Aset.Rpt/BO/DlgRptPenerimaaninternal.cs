...
{
  #region Usadi.Valid49.BO.DlgRptPenerimaaninternalControl, Usadi.Valid49.Aset.Rpt
  [Serializable]
  public class DlgRptPenerimaaninternalControl : DaftunitControl, IDataControlUIEntry, IPrintable
  {
    ...
    public DlgRptPenerimaaninternalControl()
    {
    ...
    public string GetURLReport(int n)
    {
      ...
      CS[ReportUtils.RPTNAME] = "PENERIMAAN_INTERNAL.rpt";
      CS[ReportUtils.PDFNAME] = "PENERIMAAN_INTERNAL_" + (string)GlobalAsp.GetSessionUser().GetValue("Userid") + "_" + DateTime.Now.ToString("yyyyMMddHHmmss") + ".pdf";
      ...
      string pdfurl = ReportUtils.ExportPDF("Usadi.Valid49.Aset.Rpt.Rpt.PENERIMAAN_INTERNAL.rpt", CS, Params);
      return pdfurl;
    }
    ...
    {
      RptPars rptPar = new RptPars() { Title = "Laporan Penerimaan BMD Internal", RptClass = LinkPdf };
  ...
  #endregion DlgRptPenerimaaninternal
}
