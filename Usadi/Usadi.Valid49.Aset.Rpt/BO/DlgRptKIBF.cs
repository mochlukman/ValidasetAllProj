...
{
  #region Usadi.Valid49.BO.DlgRptKIBFControl, Usadi.Valid49.Aset.Rpt
  [Serializable]
  public class DlgRptKIBFControl : DaftunitControl, IDataControlUIEntry, IPrintable
  {
    ...
    public string GetURLReport(int n)
    {
      ...
      CS[ReportUtils.RPTNAME] = "KIB_F.rpt";
      CS[ReportUtils.PDFNAME] = "KIBF_" + (string)GlobalAsp.GetSessionUser().GetValue("Userid") + "_" + DateTime.Now.ToString("yyyyMMddHHmmss") + ".pdf";
      ...
      if(n == 0)
      {
        pdfurl = ReportUtils.ExportPDF("Usadi.Valid49.Aset.Rpt.Rpt.KIB_F.rpt", CS, Params);
      }
      else
      {
        CS[ReportUtils.PDFNAME] = "KIBF_" + (string)GlobalAsp.GetSessionUser().GetValue("Userid") + "_" + DateTime.Now.ToString("yyyyMMddHHmmss") + ".xls";
        pdfurl = ReportUtils.ExportExcel("Usadi.Valid49.Aset.Rpt.Rpt.KIB_F.rpt", CS, Params);
      } 
      return pdfurl;
    }
