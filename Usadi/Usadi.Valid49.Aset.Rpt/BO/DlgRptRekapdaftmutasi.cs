...
{
  #region Usadi.Valid49.BO.DlgRptRekapdaftmutasiControl, Usadi.Valid49.Aset.Rpt
  [Serializable]
  public class DlgRptRekapdaftmutasiControl : DaftunitControl, IDataControlUIEntry, IPrintable
  {
    ...
    public DlgRptRekapdaftmutasiControl()
    {
    ...
    public string GetURLReport(int n)
    {
      ...
      CS[ReportUtils.RPTNAME] = "REKAPDAFTMUTASI.rpt";
      CS[ReportUtils.PDFNAME] = "REKAPDAFTMUTASI_" + (string)GlobalAsp.GetSessionUser().GetValue("Userid") + "_" + DateTime.Now.ToString("yyyyMMddHHmmss") + ".pdf";
      ...
      string pdfurl = ReportUtils.ExportPDF("Usadi.Valid49.Aset.Rpt.Rpt.REKAPDAFTMUTASI.rpt", CS, Params);
      return pdfurl;
    }
    ...
    {
      RptPars rptPar = new RptPars() { Title = "REKAP DAFT MUTASI", RptClass = LinkPdf };
  ...
  #endregion DlgRptRekapdaftmutasi
}
