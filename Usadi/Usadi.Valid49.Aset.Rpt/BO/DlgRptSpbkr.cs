...
{
  #region Usadi.Valid49.BO.DlgRptSpbkrControl, Usadi.Valid49.Aset.Rpt
  [Serializable]
  public class DlgRptSpbkrControl : DaftunitControl, IDataControlUIEntry, IPrintable
  {
    ...
    public string GetURLReport(int n)
    {
      ...
      CS[ReportUtils.RPTNAME] = "SPBKR.rpt";
      CS[ReportUtils.PDFNAME] = "SPBKR_" + (string)GlobalAsp.GetSessionUser().GetValue("Userid") + "_" + DateTime.Now.ToString("yyyyMMddHHmmss") + ".pdf";
      ...
      if(n == 0)
      {
        pdfurl = ReportUtils.ExportPDF("Usadi.Valid49.Aset.Rpt.Rpt.SPBKR.rpt", CS, Params);
      }
      else
      {
        CS[ReportUtils.PDFNAME] = "SPBKR_" + (string)GlobalAsp.GetSessionUser().GetValue("Userid") + "_" + DateTime.Now.ToString("yyyyMMddHHmmss") + ".xls";
        pdfurl = ReportUtils.ExportExcel("Usadi.Valid49.Aset.Rpt.Rpt.SPBKR.rpt", CS, Params);
      } 
      return pdfurl;
    }
