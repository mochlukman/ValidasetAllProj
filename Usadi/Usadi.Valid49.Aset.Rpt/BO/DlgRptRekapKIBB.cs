...
{
  #region Usadi.Valid49.BO.DlgRptRekapKIBBControl, Usadi.Valid49.Aset.Rpt
  [Serializable]
  public class DlgRptRekapKIBBControl : DaftunitControl, IDataControlUIEntry, IPrintable
  {
    ...
    public string GetURLReport(int n)
    {
      ...
      CS[ReportUtils.RPTNAME] = "KIB_B_REKAP.rpt";
      CS[ReportUtils.PDFNAME] = "KIB_B_REKAP_" + (string)GlobalAsp.GetSessionUser().GetValue("Userid") + "_" + DateTime.Now.ToString("yyyyMMddHHmmss") + ".pdf";
      ...
      if(n == 0)
      {
        pdfurl = ReportUtils.ExportPDF("Usadi.Valid49.Aset.Rpt.Rpt.KIB_B_REKAP.rpt", CS, Params);
      }
      else
      {
        CS[ReportUtils.PDFNAME] = "KIB_B_REKAP_" + (string)GlobalAsp.GetSessionUser().GetValue("Userid") + "_" + DateTime.Now.ToString("yyyyMMddHHmmss") + ".xls";
        pdfurl = ReportUtils.ExportExcel("Usadi.Valid49.Aset.Rpt.Rpt.KIB_B_REKAP.rpt", CS, Params);
      } 
      return pdfurl;
    }
