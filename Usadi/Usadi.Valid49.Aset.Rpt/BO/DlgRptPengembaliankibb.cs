...
{
  #region Usadi.Valid49.BO.DlgRptPengembaliankibbControl, Usadi.Valid49.Aset.Rpt
  [Serializable]
  public class DlgRptPengembaliankibbControl : DaftunitControl, IDataControlUIEntry, IPrintable
  {
    ...
    public DlgRptPengembaliankibbControl()
    {
    ...
    public string GetURLReport(int n)
    {
      ...
      CS[ReportUtils.RPTNAME] = "PENGEMBALIANKIBB.rpt";
      CS[ReportUtils.PDFNAME] = "PENGEMBALIANKIBB_" + (string)GlobalAsp.GetSessionUser().GetValue("Userid") + "_" + DateTime.Now.ToString("yyyyMMddHHmmss") + ".pdf";
      ...
      if (n == 0)
      {
        pdfurl = ReportUtils.ExportPDF("Usadi.Valid49.Aset.Rpt.Rpt.PENGEMBALIANKIBB.rpt", CS, Params);
      }
      else
      {
        CS[ReportUtils.PDFNAME] = "PENGEMBALIANKIBB_" + (string)GlobalAsp.GetSessionUser().GetValue("Userid") + "_" + DateTime.Now.ToString("yyyyMMddHHmmss") + ".xls";
        pdfurl = ReportUtils.ExportExcel("Usadi.Valid49.Aset.Rpt.Rpt.PENGEMBALIANKIBB.rpt", CS, Params);
      }
      return pdfurl;
    }
