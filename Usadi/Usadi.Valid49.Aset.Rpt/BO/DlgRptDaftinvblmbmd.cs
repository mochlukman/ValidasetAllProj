...
{
  #region Usadi.Valid49.BO.DlgRptDaftinvblmbmdControl, Usadi.Valid49.Aset.Rpt
  [Serializable]
  public class DlgRptDaftinvblmbmdControl : DaftunitControl, IDataControlUIEntry, IPrintable
  {
    ...
    public DlgRptDaftinvblmbmdControl()
    {
    ...
    public string GetURLReport(int n)
    {
      ...
      CS[ReportUtils.RPTNAME] = "DAFTINV_BLMBMD.rpt";
      CS[ReportUtils.PDFNAME] = "DAFTINV_BLMBMD_" + (string)GlobalAsp.GetSessionUser().GetValue("Userid") + "_" + DateTime.Now.ToString("yyyyMMddHHmmss") + ".pdf";
      ...
      string pdfurl = ReportUtils.ExportPDF("Usadi.Valid49.Aset.Rpt.Rpt.DAFTINV_BLMBMD.rpt", CS, Params);
      return pdfurl;
    }
    ...
    {
      RptPars rptPar = new RptPars() { Title = "DAFT BMD INV", RptClass = LinkPdf };
