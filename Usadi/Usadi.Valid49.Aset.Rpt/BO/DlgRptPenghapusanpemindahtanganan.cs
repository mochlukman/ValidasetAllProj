...
{
  #region Usadi.Valid49.BO.DlgRptPenghapusanpemindahtangananControl, Usadi.Valid49.Aset.Rpt
  [Serializable]
  public class DlgRptPenghapusanpemindahtangananControl : DaftunitControl, IDataControlUIEntry, IPrintable
  {
    ...
    public DlgRptPenghapusanpemindahtangananControl()
    {
    ...
    public string GetURLReport(int n)
    {
      ...
      CS[ReportUtils.RPTNAME] = $"PENGHAPUSAN_PEMINDAHTANGANAN_{StrMode}.rpt";
      CS[ReportUtils.PDFNAME] = $"PENGHAPUSAN_PEMINDAHTANGANAN_{StrMode}_{(string)GlobalAsp.GetSessionUser().GetValue("Userid")}_{ DateTime.Now.ToString("yyyyMMddHHmmss")}.pdf";
      ...
      MapMode["pemindahtanganan"] = "PEMINDAHTANGANAN";
      MapMode["pengalihan status"] = "PENGALIHANSTATUS";
      MapMode["putusan pengadilan"] = "PUTUSANPENGADILAN";
      MapMode["perpu"] = "PERPU";
      MapMode["musnah"] = "MUSNAH";
      MapMode["sebab lain"] = "SEBABLAIN";
      MapMode["semua"] = "SEMUA";

      string cname = "Usadi.Valid49.Aset.Rpt.Rpt.PENGHAPUSAN_PEMINDAHTANGANAN.rpt";
      if (!StrMode.Equals("default"))
      {
        //string strmode = StrMode.Replace(" ", "");
        string strmode = MapMode[StrMode.ToLower()];
        cname = $"Usadi.Valid49.Aset.Rpt.Rpt.PENGHAPUSAN_{strmode}.rpt";
      }
      ...
      {
        CS[ReportUtils.PDFNAME] = $"PENGHAPUSAN_{StrMode}_"+ (string)GlobalAsp.GetSessionUser().GetValue("Userid") + "_" + DateTime.Now.ToString("yyyyMMddHHmmss") + ".xls";
        pdfurl = ReportUtils.ExportPDF(cname, CS, Params);
      }
      return pdfurl;
  ...
  #endregion DlgRptPenghapusanpemindahtanganan
}
