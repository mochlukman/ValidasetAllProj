...
{
  #region Usadi.Valid49.BO.DlgRptRincpengadaanasettetapintraControl, Usadi.Valid49.Aset.Rpt
  [Serializable]
  public class DlgRptRincpengadaanasettetapintraControl : DaftunitControl, IDataControlUIEntry, IPrintable
  {
    ...
    public DlgRptRincpengadaanasettetapintraControl()
    {
    ...
    public override HashTableofParameterRow GetEntries()
    {
      ...
      hpars.Add(MatangrRptLookupControl.Instance.GetLookupParameterRow(this, false));
    ...
    public string GetURLReport(int n)
    {
      ...
      CS[ReportUtils.RPTNAME] = "RINCPENGADAAN_ASETTETAPINTRA.rpt";
      CS[ReportUtils.PDFNAME] = "RINCPENGADAAN_ASETTETAPINTRA_" + (string)GlobalAsp.GetSessionUser().GetValue("Userid") + "_" + DateTime.Now.ToString("yyyyMMddHHmmss") + ".pdf";


      Hashtable Params = new Hashtable();
      Params["@unitkey"] = Unitkey;
      Params["@Kdklas"] = Kdklas;
      Params["@mtgkey"] = Mtgkey;
      Params["@tglawal"] = Tglawal;
      Params["@tglakhir"] = Tglakhir;
      Params["@subunit"] = Subunit;


      string pdfurl = ReportUtils.ExportPDF("Usadi.Valid49.Aset.Rpt.Rpt.RINCPENGADAAN_ASETTETAPINTRA.rpt", CS, Params);
      return pdfurl;
    }
    ...
    {
      RptPars rptPar = new RptPars() { Title = "Perolehan/Penerimaan BMD Berupa Aset Tetap Pemda", RptClass = LinkPdf };
  ...
  #endregion DlgRptRincpengadaanasettetapintra
}
