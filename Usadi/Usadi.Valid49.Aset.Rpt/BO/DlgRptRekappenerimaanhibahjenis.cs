...
{
  #region Usadi.Valid49.BO.DlgRptRekappenerimaanhibahjenisControl, Usadi.Valid49.Aset.Rpt
  [Serializable]
  public class DlgRptRekappenerimaanhibahjenisControl : DaftunitControl, IDataControlUIEntry, IPrintable
  {
    ...
    public DlgRptRekappenerimaanhibahjenisControl()
    {
    ...
    public string GetURLReport(int n)
    {
      ...
      MapMode["hibah"] = "HIBAH_JENIS";
      MapMode["kontrak"] = "KONTRAK_JENIS";
      MapMode["uu"] = "UU_JENIS";
      MapMode["pengadilan"] = "PENGADILAN_JENIS";
      MapMode["divestasi"] = "DIVESTASI_JENIS";
      MapMode["inventarisasi"] = "INVENTARISASI_JENIS";
      MapMode["tukar menukar"] = "TUKARMENUKAR_JENIS";
      MapMode["pembatalan penghapusan"] = "PEMBATALANPENGHAPUSAN_JENIS";
      MapMode["perolehan lainnya"] = "PEROLEHANLAINNYA_JENIS";

      string cname = "Usadi.Valid49.Aset.Rpt.Rpt.REKAPPENERIMAAN_HIBAH_JENIS.rpt";
      if (!StrMode.Equals("default"))
      {
    ...
    {
      RptPars rptPar = new RptPars() { Title = "Perolehan/Penerimaan BMD Menurut Jenis", RptClass = LinkPdf };
  ...
  #endregion DlgRptRekappenerimaanhibahjenis
}
