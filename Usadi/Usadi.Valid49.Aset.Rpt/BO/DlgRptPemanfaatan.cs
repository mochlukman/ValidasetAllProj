...
{
  #region Usadi.Valid49.BO.DlgRptPemanfaatanControl, Usadi.Valid49.Aset.Rpt
  [Serializable]
  public class DlgRptPemanfaatanControl : DaftunitControl, IDataControlUIEntry, IPrintable
  {
    ...
    public DlgRptPemanfaatanControl()
    {
    ...
    public string GetURLReport(int n)
    {
      ...
      CS[ReportUtils.RPTNAME] = "PEMANFAATAN.rpt";
      CS[ReportUtils.PDFNAME] = "PEMANFAATAN_" + (string)GlobalAsp.GetSessionUser().GetValue("Userid") + "_" + DateTime.Now.ToString("yyyyMMddHHmmss") + ".pdf";
      ...
      string pdfurl = ReportUtils.ExportPDF("Usadi.Valid49.Aset.Rpt.Rpt.PEMANFAATAN.rpt", CS, Params);
      return pdfurl;
    }
    ...
    {
      RptPars rptPar = new RptPars() { Title = "Laporan Pemanfaatan BMD", RptClass = LinkPdf };
