...
{
  #region Usadi.Valid49.BO.DlgRptPemakaiankibbControl, Usadi.Valid49.Aset.Rpt
  [Serializable]
  public class DlgRptPemakaiankibbControl : DaftunitControl, IDataControlUIEntry, IPrintable
  {
    ...
    public DlgRptPemakaiankibbControl()
    {
    ...
    public string GetURLReport(int n)
    {
      ...
      CS[ReportUtils.RPTNAME] = "PEMAKAIANKIBB.rpt";
      CS[ReportUtils.PDFNAME] = "PEMAKAIANKIBB_" + (string)GlobalAsp.GetSessionUser().GetValue("Userid") + "_" + DateTime.Now.ToString("yyyyMMddHHmmss") + ".pdf";
      ...
      if (n == 0)
      {
        pdfurl = ReportUtils.ExportPDF("Usadi.Valid49.Aset.Rpt.Rpt.PEMAKAIANKIBB.rpt", CS, Params);
      }
      else
      {
        CS[ReportUtils.PDFNAME] = "PEMAKAIANKIBB_" + (string)GlobalAsp.GetSessionUser().GetValue("Userid") + "_" + DateTime.Now.ToString("yyyyMMddHHmmss") + ".xls";
        pdfurl = ReportUtils.ExportExcel("Usadi.Valid49.Aset.Rpt.Rpt.PEMAKAIANKIBB.rpt", CS, Params);
      }
      return pdfurl;
    }
