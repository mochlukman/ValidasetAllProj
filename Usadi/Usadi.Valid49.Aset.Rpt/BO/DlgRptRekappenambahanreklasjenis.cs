...
{
  #region Usadi.Valid49.BO.DlgRptRekappenambahanreklasjenisControl, Usadi.Valid49.Aset.Rpt
  [Serializable]
  public class DlgRptRekappenambahanreklasjenisControl : DaftunitControl, IDataControlUIEntry, IPrintable
  {
    ...
    public DlgRptRekappenambahanreklasjenisControl()
    {
    ...
    public string GetURLReport(int n)
    {
      ...
      CS[ReportUtils.RPTNAME] = "REKAPPENAMBAHAN_REKLAS_JENIS.rpt";
      CS[ReportUtils.PDFNAME] = "REKAPPENAMBAHAN_REKLAS_JENIS_" + (string)GlobalAsp.GetSessionUser().GetValue("Userid") + "_" + DateTime.Now.ToString("yyyyMMddHHmmss") + ".pdf";
      ...
      string pdfurl = ReportUtils.ExportPDF("Usadi.Valid49.Aset.Rpt.Rpt.REKAPPENAMBAHAN_REKLAS_JENIS.rpt", CS, Params);
      return pdfurl;
    }
    ...
    {
      RptPars rptPar = new RptPars() { Title = "Rekapitulasi Penambahan Reklasifikasi BMD Menurut Jenis", RptClass = LinkPdf };
  ...
  #endregion DlgRptDlgRptRekappenambahanreklasjenis
}
