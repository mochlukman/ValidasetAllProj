...
{
  #region Usadi.Valid49.BO.DlgRptRekappenggunaanpspjenisControl, Usadi.Valid49.Aset.Rpt
  [Serializable]
  public class DlgRptRekappenggunaanpspjenisControl : DaftunitControl, IDataControlUIEntry, IPrintable
  {
    ...
    public DlgRptRekappenggunaanpspjenisControl()
    {
    ...
    public string GetURLReport(int n)
    {
      ...
      CS[ReportUtils.RPTNAME] = "REKAPPENGGUNAAN_PSP_JENIS.rpt";
      CS[ReportUtils.PDFNAME] = "RREKAPPENGGUNAAN_PSP_JENIS_" + (string)GlobalAsp.GetSessionUser().GetValue("Userid") + "_" + DateTime.Now.ToString("yyyyMMddHHmmss") + ".pdf";
      ...
      string pdfurl = ReportUtils.ExportPDF("Usadi.Valid49.Aset.Rpt.Rpt.REKAPPENGGUNAAN_PSP_JENIS.rpt", CS, Params);
      return pdfurl;
    }
    ...
    {
      RptPars rptPar = new RptPars() { Title = "Rekapitulasi Penerimaan Penggunaan Menurut Jenis", RptClass = LinkPdf };
  ...
  #endregion DlgRptRekappenggunaanpspjenis
}
