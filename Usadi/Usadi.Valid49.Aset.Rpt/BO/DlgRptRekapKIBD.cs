...
{
  #region Usadi.Valid49.BO.DlgRptRekapKIBDControl, Usadi.Valid49.Aset.Rpt
  [Serializable]
  public class DlgRptRekapKIBDControl : DaftunitControl, IDataControlUIEntry, IPrintable
  {
    ...
    public string GetURLReport(int n)
    {
      ...
      CS[ReportUtils.RPTNAME] = "KIB_D_REKAP.rpt";
      CS[ReportUtils.PDFNAME] = "KIBD_REKAP_" + (string)GlobalAsp.GetSessionUser().GetValue("Userid") + "_" + DateTime.Now.ToString("yyyyMMddHHmmss") + ".pdf";
      ...
      if(n == 0)
      {
        pdfurl = ReportUtils.ExportPDF("Usadi.Valid49.Aset.Rpt.Rpt.KIB_D_REKAP.rpt", CS, Params);
      }
      else
      {
        CS[ReportUtils.PDFNAME] = "KIBD_REKAP_" + (string)GlobalAsp.GetSessionUser().GetValue("Userid") + "_" + DateTime.Now.ToString("yyyyMMddHHmmss") + ".xls";
        pdfurl = ReportUtils.ExportExcel("Usadi.Valid49.Aset.Rpt.Rpt.KIB_D_REKAP.rpt", CS, Params);
      } 
      return pdfurl;
    }
