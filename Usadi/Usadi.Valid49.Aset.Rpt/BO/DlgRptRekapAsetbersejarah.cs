...
{
  #region Usadi.Valid49.BO.DlgRptRekapAsetbersejarahControl, Usadi.Valid49.Aset.Rpt
  [Serializable]
  public class DlgRptRekapAsetbersejarahControl : DaftunitControl, IDataControlUIEntry, IPrintable
  {
    ...
    public DlgRptRekapAsetbersejarahControl()
    {
    ...
    public override HashTableofParameterRow GetEntries()
    {
      ...
      hpars.Add(DaftasetSejarahLookupControl.Instance.GetLookupParameterRow(this, false).SetEnable(enableFilter));
    ...
    public string GetURLReport(int n)
    {
      ...
      CS[ReportUtils.RPTNAME] = "ASETSEJARAH_REKAP.rpt";
      CS[ReportUtils.PDFNAME] = "ASETSEJARAH_REKAP_" + (string)GlobalAsp.GetSessionUser().GetValue("Userid") + "_" + DateTime.Now.ToString("yyyyMMddHHmmss") + ".pdf";
      ...
      if(n == 0)
      {
        pdfurl = ReportUtils.ExportPDF("Usadi.Valid49.Aset.Rpt.Rpt.ASETSEJARAH_REKAP.rpt", CS, Params);
      }
      else
      {
        CS[ReportUtils.PDFNAME] = "ASETSEJARAH_REKAP_" + (string)GlobalAsp.GetSessionUser().GetValue("Userid") + "_" + DateTime.Now.ToString("yyyyMMddHHmmss") + ".xls";
        pdfurl = ReportUtils.ExportExcel("Usadi.Valid49.Aset.Rpt.Rpt.ASETSEJARAH_REKAP.rpt", CS, Params);
      } 
      return pdfurl;
    }
