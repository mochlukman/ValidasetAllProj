...
{
  #region Usadi.Valid49.BO.DlgRptRekapAsetlainlainControl, Usadi.Valid49.Aset.Rpt
  [Serializable]
  public class DlgRptRekapAsetlainlainControl : DaftunitControl, IDataControlUIEntry, IPrintable
  {
    ...
    public DlgRptRekapAsetlainlainControl()
    {
    ...
    public override HashTableofParameterRow GetEntries()
    {
      ...
      hpars.Add(DaftasetKibLookupControl.Instance.GetLookupParameterRow(this, false).SetEnable(enableFilter));
    ...
    public string GetURLReport(int n)
    {
      ...
      CS[ReportUtils.RPTNAME] = "ASETLAINLAIN_REKAP.rpt";
      CS[ReportUtils.PDFNAME] = "ASETLAINLAIN_REKAP_" + (string)GlobalAsp.GetSessionUser().GetValue("Userid") + "_" + DateTime.Now.ToString("yyyyMMddHHmmss") + ".pdf";
      ...
      if (n == 0)
      {
        pdfurl = ReportUtils.ExportPDF("Usadi.Valid49.Aset.Rpt.Rpt.ASETLAINLAIN_REKAP.rpt", CS, Params);
      }
      else
      {
        CS[ReportUtils.PDFNAME] = "ASETLAINLAIN_REKAP_" + (string)GlobalAsp.GetSessionUser().GetValue("Userid") + "_" + DateTime.Now.ToString("yyyyMMddHHmmss") + ".xls";
        pdfurl = ReportUtils.ExportExcel("Usadi.Valid49.Aset.Rpt.Rpt.ASETLAINLAIN_REKAP.rpt", CS, Params);
      }
      return pdfurl;
    }
