...
{
  #region Usadi.Valid49.BO.DlgRptRekappengeluaranpenerimaaninternalControl, Usadi.Valid49.Aset.Rpt
  [Serializable]
  public class DlgRptRekappengeluaranpenerimaaninternalControl : DaftunitControl, IDataControlUIEntry, IPrintable
  {
    ...
    public DlgRptRekappengeluaranpenerimaaninternalControl()
    {
    ...
    public string GetURLReport(int n)
    {
      ...
      CS[ReportUtils.RPTNAME] = "REKAPPENGELUARANPENERIMAAN_INTERNAL.rpt";
      CS[ReportUtils.PDFNAME] = "REKAPPENGELUARANPENERIMAAN_INTERNAL_" + (string)GlobalAsp.GetSessionUser().GetValue("Userid") + "_" + DateTime.Now.ToString("yyyyMMddHHmmss") + ".pdf";
      ...
      string pdfurl = ReportUtils.ExportPDF("Usadi.Valid49.Aset.Rpt.Rpt.REKAPPENGELUARANPENERIMAAN_INTERNAL.rpt", CS, Params);
      return pdfurl;
    }
    ...
    {
      RptPars rptPar = new RptPars() { Title = "Laporan Pengeluaran BMD Internal", RptClass = LinkPdf };
  ...
  #endregion DlgRptRekappengeluaranpenerimaaninternal
}
