...
{
  #region Usadi.Valid49.BO.DlgRptRekappengeluaraninternalControl, Usadi.Valid49.Aset.Rpt
  [Serializable]
  public class DlgRptRekappengeluaraninternalControl : DaftunitControl, IDataControlUIEntry, IPrintable
  {
    ...
    public DlgRptRekappengeluaraninternalControl()
    {
    ...
    public string GetURLReport(int n)
    {
      ...
      CS[ReportUtils.RPTNAME] = "REKAPPENGELUARAN_INTERNAL.rpt";
      CS[ReportUtils.PDFNAME] = "REKAPPENGELUARAN_INTERNAL_" + (string)GlobalAsp.GetSessionUser().GetValue("Userid") + "_" + DateTime.Now.ToString("yyyyMMddHHmmss") + ".pdf";
      ...
      string pdfurl = ReportUtils.ExportPDF("Usadi.Valid49.Aset.Rpt.Rpt.REKAPPENGELUARAN_INTERNAL.rpt", CS, Params);
      return pdfurl;
    }
    ...
    {
      RptPars rptPar = new RptPars() { Title = "Rekapitulasi Pengeluaran BMD Internal", RptClass = LinkPdf };
  ...
  #endregion DlgRptRekappengeluaraninternal
}
