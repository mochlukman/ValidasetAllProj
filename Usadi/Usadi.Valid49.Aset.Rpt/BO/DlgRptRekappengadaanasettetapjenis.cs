...
{
  #region Usadi.Valid49.BO.DlgRptRekappengadaanasettetapjenisControl, Usadi.Valid49.Aset.Rpt
  [Serializable]
  public class DlgRptRekappengadaanasettetapjenisControl : DaftunitControl, IDataControlUIEntry, IPrintable
  {
    ...
    public DlgRptRekappengadaanasettetapjenisControl()
    {
    ...
    public string GetURLReport(int n)
    {
      ...
      CS[ReportUtils.RPTNAME] = "REKAPPENGADAAN_ASETTETAP_JENIS.rpt";
      CS[ReportUtils.PDFNAME] = "REKAPPENGADAAN_ASETTETAP_JENIS_" + (string)GlobalAsp.GetSessionUser().GetValue("Userid") + "_" + DateTime.Now.ToString("yyyyMMddHHmmss") + ".pdf";
      ...
      //string pdfurl = ReportUtils.ExportPDF("Usadi.Valid49.Aset.Rpt.Rpt.REKAPPENGADAAN_ASETTETAP_JENIS.rpt", CS, Params);
      string pdfurl;
      if (n == 0)
      {
        pdfurl = ReportUtils.ExportPDF("Usadi.Valid49.Aset.Rpt.Rpt.REKAPPENGADAAN_ASETTETAP_JENIS.rpt", CS, Params);
      }
      else
      {
        CS[ReportUtils.PDFNAME] = "REKAPPENGADAAN_ASETTETAP_JENIS_" + (string)GlobalAsp.GetSessionUser().GetValue("Userid") + "_" + DateTime.Now.ToString("yyyyMMddHHmmss") + ".xls";
        pdfurl = ReportUtils.ExportExcel("Usadi.Valid49.Aset.Rpt.Rpt.REKAPPENGADAAN_ASETTETAP_JENIS.rpt", CS, Params);
      }
      return pdfurl;
    }
  ...
  #endregion DlgRptRekappengadaanasettetapjenis
}
