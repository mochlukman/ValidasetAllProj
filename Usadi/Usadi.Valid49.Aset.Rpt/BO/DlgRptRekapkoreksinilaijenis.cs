...
{
  #region Usadi.Valid49.BO.DlgRptRekapkoreksinilaijenisControl, Usadi.Valid49.Aset.Rpt
  [Serializable]
  public class DlgRptRekapkoreksinilaijenisControl : DaftunitControl, IDataControlUIEntry, IPrintable
  {
    ...
    #endregion
    public DlgRptRekapkoreksinilaijenisControl()
    {
    ...
    public string GetURLReport(int n)
    {
      ...
      CS[ReportUtils.RPTNAME] = "REKAPKOREKSINILAI_JENIS.rpt";
      CS[ReportUtils.PDFNAME] = "REKAPKOREKSINILAI_JENIS_" + (string)GlobalAsp.GetSessionUser().GetValue("Userid") + "_" + DateTime.Now.ToString("yyyyMMddHHmmss") + ".pdf";
      ...
      if (n == 0)
      {
        pdfurl = ReportUtils.ExportPDF("Usadi.Valid49.Aset.Rpt.Rpt.REKAPKOREKSINILAI_JENIS.rpt", CS, Params);
      }
      else
      {
        CS[ReportUtils.PDFNAME] = "REKAPKOREKSINILAI_JENIS_" + (string)GlobalAsp.GetSessionUser().GetValue("Userid") + "_" + DateTime.Now.ToString("yyyyMMddHHmmss") + ".xls";
        pdfurl = ReportUtils.ExportExcel("Usadi.Valid49.Aset.Rpt.Rpt.REKAPKOREKSINILAI_JENIS.rpt", CS, Params);
      }
      return pdfurl;
    }
