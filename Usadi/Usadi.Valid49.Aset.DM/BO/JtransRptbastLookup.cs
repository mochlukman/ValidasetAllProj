...
{
  #region Usadi.Valid49.BO.JtransRptbastLookupControl, CoreNET.Common.BO
  [Serializable]
  public class JtransRptbastLookupControl : JtransControl, IDataControlLookup, IHasJSScript
  {
    #region Singleton
    private static JtransRptbastLookupControl _Instance = null;
    public static JtransRptbastLookupControl Instance
    {
      get
      {
        if (_Instance == null)
        {
          _Instance = new JtransRptbastLookupControl();
        }
        return _Instance;
      }
    }
    ...
    public static List<JtransControl> GetListDataSingleton()
    {
      if (_ListData == null)
      {
        JtransRptbastLookupControl dc = new JtransRptbastLookupControl();
        dc.SetPageKey();
    ...
    #endregion
    public JtransRptbastLookupControl()
    {
    ...
    public ParameterRow GetLookupParameterRow(IDataControl callerCtr, bool entry)
    {
      ...
      JtransRptbastLookupControl dclookup = new JtransRptbastLookupControl();
  ...
  #endregion JtransRptbastLookupControl
}
