...
{
  #region Usadi.Valid49.BO.DaftasetRusakberatRptLookupControl, Usadi.Valid49.Aset.DM
  [Serializable]
  public class DaftasetRusakberatRptLookupControl : DaftasetControl, IDataControlLookup, IHasJSScript
  {
    #region Singleton
    private static DaftasetRusakberatRptLookupControl _Instance = null;
    public static DaftasetRusakberatRptLookupControl Instance
    {
      get
      {
        if (_Instance == null)
        {
          _Instance = new DaftasetRusakberatRptLookupControl();
        }
        return _Instance;
      }
    }
    ...
    //    try
    //    {
    //      DaftasetRusakberatRptLookupControl dc = new DaftasetRusakberatRptLookupControl();
    //      dc.SetPageKey();
    ...
    #endregion
    public DaftasetRusakberatRptLookupControl()
    {
    ...
    {
      IList list = this.View("Rusakberat");
      return list;
    }
    public ParameterRow GetLookupParameterRow(IDataControl callerCtr, bool entry)
    {
      ...
      DaftasetRusakberatRptLookupControl dclookup = new DaftasetRusakberatRptLookupControl();
  ...
  #endregion DaftasetRusakberatRptLookup
}
