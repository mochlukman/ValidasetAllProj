...
{
  #region Usadi.Valid49.BO.JbuktiLookupControl, CoreNET.Common.BO
  [Serializable]
  public class JbuktiLookupControl :  JbuktiControl, IDataControlLookup, IHasJSScript
  {
    #region Singleton
    private static  JbuktiLookupControl _Instance = null;
    public static  JbuktiLookupControl Instance
    {
      get
      {
        if (_Instance == null)
        {
          _Instance = new  JbuktiLookupControl();
        }
        return _Instance;
      }
    }
    ...
    //    try
    //    {
    //      JbuktiLookupControl dc = new JbuktiLookupControl();
    //      dc.SetPageKey();
    ...
    public ParameterRow GetLookupParameterRow(IDataControl callerCtr, bool entry)
    {
      ...
      JbuktiLookupControl dclookup = new JbuktiLookupControl();
