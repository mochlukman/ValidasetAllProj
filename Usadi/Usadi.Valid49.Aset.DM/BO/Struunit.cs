...
{
  #region Usadi.Valid49.BO.StruunitControl, Usadi.Valid49.Aset.DM
  [Serializable]
  public class StruunitControl : BaseDataControlAsetDM, IDataControlUIEntry, IHasJSScript
  {
    #region Properties
    ...
    public override DataControlFieldCollection GetColumns()
    {
      ...
      columns.Add(Fields.Create(ConstantDict.GetColumnTitle("Numdigit=Digit"), typeof(string), 70, HorizontalAlign.Left));
    ...
    public new IList View(string label)
    {
      ...
      List<StruunitControl> ListData = new List<StruunitControl>();
      foreach (StruunitControl dc in list)
      {
        ListData.Add(dc);
      }
    ...
    public override HashTableofParameterRow GetEntries()
    {
      ...
      hpars.Add(new ParameterRowTextBox(this, ConstantDict.GetColumnTitle("Numdigit=Digit"), true, 50).SetEnable(enable));
