...
{
  #region Usadi.Valid49.BO.DaftasetPersediaanLookupControl, Usadi.Valid49.Aset.DM
  [Serializable]
  public class DaftasetPersediaanLookupControl : DaftasetControl, IDataControlLookup, IHasJSScript
  {
    #region Singleton
    private static DaftasetPersediaanLookupControl _Instance = null;
    public static DaftasetPersediaanLookupControl Instance
    {
      get
      {
        if (_Instance == null)
        {
          _Instance = new DaftasetPersediaanLookupControl();
        }
        return _Instance;
      }
    }
    ...
    //    try
    //    {
    //      DaftasetPersediaanLookupControl dc = new DaftasetPersediaanLookupControl();
    //      dc.SetPageKey();
    ...
    #endregion
    public DaftasetPersediaanLookupControl()
    {
    ...
    {
      IList list = this.View("Persediaan");
      return list;
    }
    public ParameterRow GetLookupParameterRow(IDataControl callerCtr, bool entry)
    {
      ...
      DaftasetPersediaanLookupControl dclookup = new DaftasetPersediaanLookupControl();
  ...
  #endregion DaftasetPersediaanLookup
}
