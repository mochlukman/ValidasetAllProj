...
{
  #region Usadi.Valid49.BO.DaftasetReklasLookupControl, Usadi.Valid49.Aset.DM
  [Serializable]
  public class DaftasetReklasLookupControl : DaftasetControl, IDataControlLookup, IHasJSScript
  {
    #region Singleton
    private static DaftasetReklasLookupControl _Instance = null;
    public static DaftasetReklasLookupControl Instance
    {
      get
      {
        if (_Instance == null)
        {
          _Instance = new DaftasetReklasLookupControl();
        }
        return _Instance;
      }
    }
    ...
    //    try
    //    {
    //      DaftasetReklasLookupControl dc = new DaftasetReklasLookupControl();
    //      dc.SetPageKey();
    ...
    #endregion
    public DaftasetReklasLookupControl()
    {
    ...
    public ParameterRow GetLookupParameterRow(IDataControl callerCtr, bool entry)
    {
      ...
      DaftasetReklasLookupControl dclookup = new DaftasetReklasLookupControl();
  ...
  #endregion DaftasetReklasLookup
}
