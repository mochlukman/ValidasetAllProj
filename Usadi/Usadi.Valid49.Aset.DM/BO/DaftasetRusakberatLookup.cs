...
{
  #region Usadi.Valid49.BO.DaftasetRusakberatLookupControl, Usadi.Valid49.Aset.DM
  [Serializable]
  public class DaftasetRusakberatLookupControl : DaftasetControl, IDataControlLookup, IHasJSScript
  {
    #region Singleton
    private static DaftasetRusakberatLookupControl _Instance = null;
    public static DaftasetRusakberatLookupControl Instance
    {
      get
      {
        if (_Instance == null)
        {
          _Instance = new DaftasetRusakberatLookupControl();
        }
        return _Instance;
      }
    }
    ...
    //    try
    //    {
    //      DaftasetRusakberatLookupControl dc = new DaftasetRusakberatLookupControl();
    //      dc.SetPageKey();
    ...
    #endregion
    public DaftasetRusakberatLookupControl()
    {
    ...
    public ParameterRow GetLookupParameterRow(IDataControl callerCtr, bool entry)
    {
      ...
      DaftasetRusakberatLookupControl dclookup = new DaftasetRusakberatLookupControl();
  ...
  #endregion DaftasetRusakberatLookup
}
