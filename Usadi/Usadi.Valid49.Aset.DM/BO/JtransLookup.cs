...
{
  #region Usadi.Valid49.BO.JtransLookupControl, CoreNET.Common.BO
  [Serializable]
  public class JtransLookupControl : JtransControl, IDataControlLookup, IHasJSScript
  {
    #region Singleton
    private static JtransLookupControl _Instance = null;
    public static JtransLookupControl Instance
    {
      get
      {
        if (_Instance == null)
        {
          _Instance = new JtransLookupControl();
        }
        return _Instance;
      }
    }
    ...
    public static List<JtransControl> GetListDataSingleton()
    {
      if (_ListData == null)
      {
        JtransLookupControl dc = new JtransLookupControl();
        dc.SetPageKey();
    ...
    public ParameterRow GetLookupParameterRow(IDataControl callerCtr, bool entry)
    {
      ...
      JtransLookupControl dclookup = new JtransLookupControl();
