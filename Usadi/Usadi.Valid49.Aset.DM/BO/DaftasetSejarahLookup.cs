...
{
  #region Usadi.Valid49.BO.DaftasetSejarahLookupControl, Usadi.Valid49.Aset.DM
  [Serializable]
  public class DaftasetSejarahLookupControl : DaftasetControl, IDataControlLookup, IHasJSScript
  {
    #region Singleton
    private static DaftasetSejarahLookupControl _Instance = null;
    public static DaftasetSejarahLookupControl Instance
    {
      get
      {
        if (_Instance == null)
        {
          _Instance = new DaftasetSejarahLookupControl();
        }
        return _Instance;
      }
    }
    ...
    //    try
    //    {
    //      DaftasetSejarahLookupControl dc = new DaftasetSejarahLookupControl();
    //      dc.SetPageKey();
    ...
    #endregion
    public DaftasetSejarahLookupControl()
    {
    ...
    public ParameterRow GetLookupParameterRow(IDataControl callerCtr, bool entry)
    {
      ...
      DaftasetSejarahLookupControl dclookup = new DaftasetSejarahLookupControl();
  ...
  #endregion DaftasetSejarahLookup
}
