...
{
  #region Usadi.Valid49.BO.DaftasetKirLookupControl, Usadi.Valid49.Aset.DM
  [Serializable]
  public class DaftasetKirLookupControl :  DaftasetControl, IDataControlLookup, IHasJSScript
  {
    #region Singleton
    private static  DaftasetKirLookupControl _Instance = null;
    public static  DaftasetKirLookupControl Instance
    {
      get
      {
        if (_Instance == null)
        {
          _Instance = new  DaftasetKirLookupControl();
        }
        return _Instance;
      }
    }
    ...
    //    try
    //    {
    //      DaftasetKirLookupControl dc = new DaftasetKirLookupControl();
    //      dc.SetPageKey();
    ...
    #endregion
    public DaftasetKirLookupControl()
    {
    ...
    public ParameterRow GetLookupParameterRow(IDataControl callerCtr, bool entry)
    {
      ...
      DaftasetKirLookupControl dclookup = new DaftasetKirLookupControl();
