...
{
  #region Usadi.Valid49.BO.KegunitLookupControl, CoreNET.Common.BO
  [Serializable]
  public class KegunitLookupControl : KegunitControl, IDataControlLookup, IHasJSScript
  {
    #region Singleton
    private static KegunitLookupControl _Instance = null;
    public static KegunitLookupControl Instance
    {
      get
      {
        if (_Instance == null)
        {
          _Instance = new KegunitLookupControl();
        }
        return _Instance;
      }
    }
    ...
    public static List<KegunitControl> GetListDataSingleton()
    {
      if (_ListData == null)
      {
        KegunitLookupControl dc = new KegunitLookupControl();
        dc.SetPageKey();
    ...
    public ParameterRow GetLookupParameterRow(IDataControl callerCtr, bool entry)
    {
      ...
      KegunitLookupControl dclookup = new KegunitLookupControl();
