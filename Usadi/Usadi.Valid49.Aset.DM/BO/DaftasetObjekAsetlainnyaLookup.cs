...
{
    #region Usadi.Valid49.BO.DaftasetObjekAsetlainnyaLookupControl, Usadi.Valid49.Aset.DM
    [Serializable]
    public class DaftasetObjekAsetlainnyaLookupControl : DaftasetControl, IDataControlLookup, IHasJSScript
    {
        #region Singleton
        private static DaftasetObjekAsetlainnyaLookupControl _Instance = null;
        public static DaftasetObjekAsetlainnyaLookupControl Instance
        {
            get
            {
                if (_Instance == null)
                {
                    _Instance = new DaftasetObjekAsetlainnyaLookupControl();
                }
                return _Instance;
            }
        }
        ...
        public static List<DaftasetControl> GetListDataSingleton()
        {
            if (_ListData == null)
            {
                DaftasetObjekAsetlainnyaLookupControl dc = new DaftasetObjekAsetlainnyaLookupControl();
                dc.SetPageKey();
        ...
        #endregion
        public DaftasetObjekAsetlainnyaLookupControl()
        {
        ...
        {
            IList list = this.View("ObjekAsetlainnya");
            return list;
        }
        public ParameterRow GetLookupParameterRow(IDataControl callerCtr, bool entry)
        {
            ...
            DaftasetObjekAsetlainnyaLookupControl dclookup = new DaftasetObjekAsetlainnyaLookupControl();
    ...
    #endregion DaftasetObjekAsetlainnyaLookup
}
