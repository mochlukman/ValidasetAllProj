...
{
  #region Usadi.Valid49.BO.TahunSusutLookupControl, CoreNET.Common.BO
  [Serializable]
  public class TahunSusutLookupControl :  TahunControl, IDataControlLookup, IHasJSScript
  {
    #region Singleton
    private static  TahunSusutLookupControl _Instance = null;
    public static  TahunSusutLookupControl Instance
    {
      get
      {
        if (_Instance == null)
        {
          _Instance = new  TahunSusutLookupControl();
        }
        return _Instance;
      }
    }
    ...
    //    try
    //    {
    //      TahunSusutLookupControl dc = new TahunSusutLookupControl();
    //      dc.SetPageKey();
    ...
    #endregion
    public TahunSusutLookupControl()
    {
    ...
    public ParameterRow GetLookupParameterRow(IDataControl callerCtr, bool entry)
    {
      ...
      TahunSusutLookupControl dclookup = new TahunSusutLookupControl();
