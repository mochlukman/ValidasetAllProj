...
{
    #region Usadi.Valid49.BO.DaftasetObjekPersediaanLookupControl, Usadi.Valid49.Aset.DM
    [Serializable]
    public class DaftasetObjekPersediaanLookupControl : DaftasetControl, IDataControlLookup, IHasJSScript
    {
        #region Singleton
        private static DaftasetObjekPersediaanLookupControl _Instance = null;
        public static DaftasetObjekPersediaanLookupControl Instance
        {
            get
            {
                if (_Instance == null)
                {
                    _Instance = new DaftasetObjekPersediaanLookupControl();
                }
                return _Instance;
            }
        }
        ...
        public static List<DaftasetControl> GetListDataSingleton()
        {
            if (_ListData == null)
            {
                DaftasetObjekPersediaanLookupControl dc = new DaftasetObjekPersediaanLookupControl();
                dc.SetPageKey();
        ...
        #endregion
        public DaftasetObjekPersediaanLookupControl()
        {
        ...
        {
            IList list = this.View("ObjekPersediaan");
            return list;
        }
        public ParameterRow GetLookupParameterRow(IDataControl callerCtr, bool entry)
        {
            ...
            DaftasetObjekPersediaanLookupControl dclookup = new DaftasetObjekPersediaanLookupControl();
    ...
    #endregion DaftasetObjekPersediaanLookup
}
