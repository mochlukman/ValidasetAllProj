...
{
  #region Usadi.Valid49.BO.JnskibLookupControl, CoreNET.Common.BO
  [Serializable]
  public class JnskibLookupControl :  JnskibControl, IDataControlLookup, IHasJSScript
  {
    #region Singleton
    private static  JnskibLookupControl _Instance = null;
    public static  JnskibLookupControl Instance
    {
      get
      {
        if (_Instance == null)
        {
          _Instance = new  JnskibLookupControl();
        }
        return _Instance;
      }
    }
    ...
    //    try
    //    {
    //      JnskibLookupControl dc = new JnskibLookupControl();
    //      dc.SetPageKey();
    ...
    public ParameterRow GetLookupParameterRow(IDataControl callerCtr, bool entry)
    {
      ...
      JnskibLookupControl dclookup = new JnskibLookupControl();
