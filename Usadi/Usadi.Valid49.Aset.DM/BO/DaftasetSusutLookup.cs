...
{
  #region Usadi.Valid49.BO.DaftasetSusutLookupControl, Usadi.Valid49.Aset.DM
  [Serializable]
  public class DaftasetSusutLookupControl :  DaftasetControl, IDataControlLookup, IHasJSScript
  {
    #region Singleton
    private static  DaftasetSusutLookupControl _Instance = null;
    public static  DaftasetSusutLookupControl Instance
    {
      get
      {
        if (_Instance == null)
        {
          _Instance = new  DaftasetSusutLookupControl();
        }
        return _Instance;
      }
    }
    ...
    //    try
    //    {
    //      DaftasetSusutLookupControl dc = new DaftasetSusutLookupControl();
    //      dc.SetPageKey();
    ...
    #endregion
    public DaftasetSusutLookupControl()
    {
    ...
    public ParameterRow GetLookupParameterRow(IDataControl callerCtr, bool entry)
    {
      ...
      DaftasetSusutLookupControl dclookup = new DaftasetSusutLookupControl();
