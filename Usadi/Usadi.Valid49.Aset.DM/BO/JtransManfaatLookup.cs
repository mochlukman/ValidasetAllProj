...
{
  #region Usadi.Valid49.BO.JtransManfaatLookupControl, CoreNET.Common.BO
  [Serializable]
  public class JtransManfaatLookupControl : JtransControl, IDataControlLookup, IHasJSScript
  {
    #region Singleton
    private static JtransManfaatLookupControl _Instance = null;
    public static JtransManfaatLookupControl Instance
    {
      get
      {
        if (_Instance == null)
        {
          _Instance = new JtransManfaatLookupControl();
        }
        return _Instance;
      }
    }
    ...
    public static List<JtransControl> GetListDataSingleton()
    {
      if (_ListData == null)
      {
        JtransManfaatLookupControl dc = new JtransManfaatLookupControl();
        dc.SetPageKey();
    ...
    #endregion
    public JtransManfaatLookupControl()
    {
    ...
    public ParameterRow GetLookupParameterRow(IDataControl callerCtr, bool entry)
    {
      ...
      JtransManfaatLookupControl dclookup = new JtransManfaatLookupControl();
  ...
  #endregion JtransManfaatLookupControl
}
