...
{
  #region Usadi.Valid49.BO.StruasetControl, Usadi.Valid49.Aset.DM
  [Serializable]
  public class StruasetControl : BaseDataControlAsetDM, IDataControlUIEntry, IHasJSScript
  {
    #region Properties
    ...
    public new IList View(string label)
    {
      ...
      List<StruasetControl> ListData = new List<StruasetControl>();
      foreach (StruasetControl dc in list)
      {
        ListData.Add(dc);
      }
