...
{
  #region Usadi.Valid49.BO.JbuktiLainnyaLookupControl, CoreNET.Common.BO
  [Serializable]
  public class JbuktiLainnyaLookupControl :  JbuktiControl, IDataControlLookup, IHasJSScript
  {
    #region Singleton
    private static  JbuktiLainnyaLookupControl _Instance = null;
    public static  JbuktiLainnyaLookupControl Instance
    {
      get
      {
        if (_Instance == null)
        {
          _Instance = new  JbuktiLainnyaLookupControl();
        }
        return _Instance;
      }
    }
    ...
    //    try
    //    {
    //      JbuktiLainnyaLookupControl dc = new JbuktiLainnyaLookupControl();
    //      dc.SetPageKey();
    ...
    #endregion
    public JbuktiLainnyaLookupControl()
    {
    ...
    public ParameterRow GetLookupParameterRow(IDataControl callerCtr, bool entry)
    {
      ...
      JbuktiLainnyaLookupControl dclookup = new JbuktiLainnyaLookupControl();
