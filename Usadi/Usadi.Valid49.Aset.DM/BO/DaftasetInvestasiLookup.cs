...
{
  #region Usadi.Valid49.BO.DaftasetInvestasiLookupControl, Usadi.Valid49.Aset.DM
  [Serializable]
  public class DaftasetInvestasiLookupControl : DaftasetControl, IDataControlLookup, IHasJSScript
  {
    #region Singleton
    private static DaftasetInvestasiLookupControl _Instance = null;
    public static DaftasetInvestasiLookupControl Instance
    {
      get
      {
        if (_Instance == null)
        {
          _Instance = new DaftasetInvestasiLookupControl();
        }
        return _Instance;
      }
    }
    ...
    //    try
    //    {
    //      DaftasetInvestasiLookupControl dc = new DaftasetInvestasiLookupControl();
    //      dc.SetPageKey();
    ...
    #endregion
    public DaftasetInvestasiLookupControl()
    {
    ...
    {
      IList list = this.View("Investasi");
      return list;
    }
    public ParameterRow GetLookupParameterRow(IDataControl callerCtr, bool entry)
    {
      ...
      DaftasetInvestasiLookupControl dclookup = new DaftasetInvestasiLookupControl();
  ...
  #endregion DaftasetInvestasiLookup
}
