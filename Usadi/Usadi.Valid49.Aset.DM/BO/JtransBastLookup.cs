...
{
  #region Usadi.Valid49.BO.JtransBastLookupControl, CoreNET.Common.BO
  [Serializable]
  public class JtransBastLookupControl : JtransControl, IDataControlLookup, IHasJSScript
  {
    #region Singleton
    private static JtransBastLookupControl _Instance = null;
    public static JtransBastLookupControl Instance
    {
      get
      {
        if (_Instance == null)
        {
          _Instance = new JtransBastLookupControl();
        }
        return _Instance;
      }
    }
    ...
    public static List<JtransControl> GetListDataSingleton()
    {
      if (_ListData == null)
      {
        JtransBastLookupControl dc = new JtransBastLookupControl();
        dc.SetPageKey();
    ...
    #endregion
    public JtransBastLookupControl()
    {
    ...
    public ParameterRow GetLookupParameterRow(IDataControl callerCtr, bool entry)
    {
      ...
      JtransBastLookupControl dclookup = new JtransBastLookupControl();
  ...
  #endregion JtransBastLookupControl
}
