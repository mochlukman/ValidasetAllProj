...
{
  #region CoreNET.Common.BO.SysgetrowsControl, CoreNET.Common.BO
  [Serializable]
  public class SysgetrowsControl : BaseDataControlExt, IDataControlUIEntry, IExtLoadCsv, IHasJSScript
  {
    #region Properties 
